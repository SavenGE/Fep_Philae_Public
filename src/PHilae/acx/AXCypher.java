...
public final class AXCypher {
    ...
    public static void main(String[] po) {
        AXCypher cypher = new AXCypher();
        System.err.println(cypher.decrypt("k6MjR8pvTyRrwjLHPRk5FA=="));
        System.err.println(cypher.encrypt("channelmanagerfep"));
        System.err.println(cypher.encrypt("channelmanager"));
    }
}
