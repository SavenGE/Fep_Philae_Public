...
public final class CSPanel extends javax.swing.JPanel {
    ...
    private void initComponents()
    {
        ...
        schemeDialog.setIconImage(PHilae.APMain.getIconImage());
        ...
        channelBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ATM", "VMA", "MOBILE", "POS", "SMS", "ACH", "EST", "VOM" }));
        ...
        schemeTree.setCellRenderer(new PHilae.acx.TRenderer());
    ...
    public void setSchemeTree() {
        ...
        setSchemes(getClient().querySchemes(getModule()));
    ...
    private void acceptScheme() {
        ...
        getScheme().setCode(getWorker().nextCode(getSchemes(), getModule().substring(0, 1)));
    ...
    public void showDialog(String module) {
        setModule(module);
        setSchemeTree();
        getWorker().selectBoxValue(channelBox, getModule());
        schemeDialog.setTitle((getModule().length() > 3 ? getWorker().capitalize(getModule()) : getModule()) + " Schemes");
        EventQueue.invokeLater(()
                -> {
    ...
    {//GEN-HEADEREND:event_saveButtonActionPerformed
        ...
        if (getWorker().validateFields(schemeDialog, this)) {
            ...
            getScheme().setModule(getWorker().getBoxValue(channelBox));
            ...
            if (proceed) {
                ...
                if (getClient().upsertScheme(getScheme())) {
