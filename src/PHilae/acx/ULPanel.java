...
public final class ULPanel extends javax.swing.JPanel {
    ...
    private void initComponents()
    {
        ...
        loginDialog.setIconImage(PHilae.APMain.getIconImage());
    ...
    private void loginUser() {
        if (passwordField.getPassword().length == 0) {
            ...
            setUser(getClient().loginUser(getUserID(), getPassword(), getRole()));
            getLog().logEvent(getWorker().isBlank(getUser().getUserName()) ? "Login failed. User [ " + getUserID() + " ], Module [ " + getModule() + " ]" : "Login successful. User [ " + getUserID() + " ], Name [ " + getUser().getStaffName() + " ], Module [ " + getModule() + " ]");
            ...
            if (getUser().getRoles().contains(getRole())) {
                ...
                userIdField.setText(getWorker().isBlank(getUser().getStaffName()) ? "Login Failed!" : "Access Denied!");
                userIdField.requestFocus();
