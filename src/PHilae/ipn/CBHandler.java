 ...
 * @author Pecherk
 */
public class CBHandler extends AbstractHandler {
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            if (box.getWorker().isJson(reqMessage)) {
                ...
                mpesaDeposit(cBRequest, responseCode, responseMessage, errorMessage);
                ...
                box.getLog().logEvent("======<[ vmt <[ CB=<" + request.getRemoteAddr() + "> message=<" + reqMessage + "> ]> ping ]>======");
    ...
    public void mpesaDeposit(CBRequest cBRequest, Holder<String> responseCode, Holder<String> responseMessage, Holder<String> errorMessage) {
        Method method = new Object() {
        }.getClass().getEnclosingMethod();
        System.err.println("CBHandler --> " + method.getName());
        new VXProcessor(new VXCaller(cBRequest.getClient(), TXType.MpesaDeposit,
