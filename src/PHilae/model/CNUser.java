...
public class CNUser implements Serializable {
    ...
    private ArrayList<CNAccount> nwdAccounts = new ArrayList<>();
    ...
    /**
     * @return the nwdAccounts
     */
    public ArrayList<CNAccount> getNwdAccounts() {
        return nwdAccounts;
    }

    /**
     * @param nwdAccounts the nwdAccounts to set
     */
    public void setNwdAccounts(ArrayList<CNAccount> nwdAccounts) {
        this.nwdAccounts = nwdAccounts;
    }
}
