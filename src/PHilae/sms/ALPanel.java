...
public final class ALPanel extends javax.swing.JPanel {
    ...
    public void initDialog() {
        ...
        nextDateChooser.setMinSelectableDate(getClient().getProcessingDate());
        expiryDateChooser.setMinSelectableDate(getClient().getProcessingDate());
    }
    ...
    private void initComponents()
    {
        ...
        filterTree = new PHilae.sms.ALTree(this);
        ...
        originatorPHMenuItem = new javax.swing.JMenuItem();
        ...
        contraPHMenuItem = new javax.swing.JMenuItem();
        beneficiaryPHMenuItem = new javax.swing.JMenuItem();
        ...
        rfPanel = new PHilae.acx.AFPanel(filterByBox, filterScroller);
        ...
        acctNoPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        custNamePHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        currencyPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        amountPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        chargePHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        descriptionPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        datePHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        originatorPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        originatorPHMenuItem.setText("Transaction Originator");
        originatorPHMenuItem.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                originatorPHMenuItemActionPerformed(evt);
            }
        });
        templatePopupMenu.add(originatorPHMenuItem);

        daysPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        accessCodePHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        pinPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        pinPHMenuItem.setText("New PIN");
        ...
        balancePHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        ...
        contraPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        contraPHMenuItem.setText("Contra Account Number");
        contraPHMenuItem.setToolTipText("");
        contraPHMenuItem.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                contraPHMenuItemActionPerformed(evt);
            }
        });
        templatePopupMenu.add(contraPHMenuItem);

        beneficiaryPHMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PHilae/ximg/cert.png"))); // NOI18N
        beneficiaryPHMenuItem.setText("Beneficiary Name");
        beneficiaryPHMenuItem.setToolTipText("");
        beneficiaryPHMenuItem.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                beneficiaryPHMenuItemActionPerformed(evt);
            }
        });
        templatePopupMenu.add(beneficiaryPHMenuItem);
        ...
        alertDialog.setTitle("PHilae Alerts");
        alertDialog.setIconImage(PHilae.APMain.getIconImage());
        ...
        alertTypeBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "---select---", "CR~Credit", "CV~Credit Reversal", "DR~Debit", "DV~Debit Reversal", "LA~Loan Arrears", "LD~Loan Due", "LF~Loan Default", "PC~PIN Change", "SD~Deactivation", "SE~Enrollment", "LB~Loan Disbursement", "LR~Loan Repayment", "GA~Guarantor", "BR~Broadcast" }));
        ...
        templateTree.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        templateTree.setForeground(new java.awt.Color(51, 102, 255));
        ...
        templateTree.setCellRenderer(new TRenderer());
        templateTree.setRootVisible(false);
        templateTree.setShowsRootHandles(true);
        templateTree.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener()
        {
            public void valueChanged(javax.swing.event.TreeSelectionEvent evt)
            {
                templateTreeValueChanged(evt);
            }
        });
        templatesTreeScroller.setViewportView(templateTree);
        ...
        statusBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "A~Active", "C~Closed", "E~Expired", "L~Loaded" }));
    ...
    {//GEN-HEADEREND:event_saveButtonActionPerformed
        ...
        if (getWorker().validateFields(alertDialog, this, templatesPanel, filtersPanel) && validateTemplates() && validateFilters()) {
            getAlert().setCode(alertCodeField.getText());
            getAlert().setType(getWorker().getBoxValue(alertTypeBox));
            ...
            if (getAlert().isReminder()) {
                getAlert().setDays(alertDaysField.getText());
            }
            ...
            boolean proceed = getAlerts().containsKey(getAlert().getCode())
            ...
            if (proceed) {
                getAlerts().put(getAlert().getCode(), getAlert());
                if (getClient().upsertAlert(getAlert())) {
    ...
    {//GEN-HEADEREND:event_executeButtonActionPerformed
        ...
        if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(alertDialog, "Are you sure you want to execute this alert?", "Confirm Execute", JOptionPane.YES_NO_OPTION)) {
            ...
            getAlert().setNextDate(getClient().getProcessingDate());
            getAlert().setStatus("A");
            getAlerts().put(getAlert().getCode(), getAlert());
            getClient().upsertAlert(getAlert());
            setAlertTree();
        }
    ...
    {//GEN-HEADEREND:event_deleteButtonActionPerformed
        ...
        if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(alertDialog, "Are you sure you want to delete this alert?", "Confirm Delete", JOptionPane.YES_NO_OPTION)) {
            if (getClient().deleteAlert(getAlert())) {
    ...
    private void templateTreeValueChanged(javax.swing.event.TreeSelectionEvent evt)//GEN-FIRST:event_templateTreeValueChanged
    {//GEN-HEADEREND:event_templateTreeValueChanged
        // TODO add your handling code here:
        String[] lang;
        DefaultMutableTreeNode selectedNode = (DefaultMutableTreeNode) templateTree.getLastSelectedPathComponent();
        if (selectedNode != null && (lang = selectedNode.getUserObject().toString().split("~")).length > 1) {
            templateArea.setText(getAlert().getTemplates().get(lang[0].trim()));
            ((TitledBorder) templateDisplayPanel.getBorder()).setTitle(lang[1].trim() + "~Template");
            templateDisplayPanel.updateUI();
        }
    }//GEN-LAST:event_templateTreeValueChanged
    ...
    public void setTemplateTree() {
        ...
        getWorker().selectTreeNode(templateTree, APController.defaultLanguage);
    }
    ...
    public void showFilterDialog() {
        EventQueue.invokeLater(()
            ...
            if ("AP".equals(filterBy) || "BU".equals(filterBy) || "CS".equals(filterBy) || "CT".equals(filterBy)) {
                ...
                switch (filterBy) {
                    case "AP":
                        ((ALTree) filterTree).setFilterTree(getClient().queryProducts(), ("AP".equals(getAlert().getFilterBy()) ? getAlert().getFilters().toArray(new String[0]) : new String[0]), "All Products");
                        break;
                    case "BU":
                        ((ALTree) filterTree).setFilterTree(getClient().queryBranches(), ("BU".equals(getAlert().getFilterBy()) ? getAlert().getFilters().toArray(new String[0]) : new String[0]), "Business Units");
                        break;
                    case "CS":
                        ((ALTree) filterTree).setFilterTree(getClient().queryChannelSchemes(), ("CS".equals(getAlert().getFilterBy()) ? getAlert().getFilters().toArray(new String[0]) : new String[0]), "Channel Schemes");
                        break;
                    case "CT":
                        ((ALTree) filterTree).setFilterTree(getClient().queryCustomerTypes(), ("CT".equals(getAlert().getFilterBy()) ? getAlert().getFilters().toArray(new String[0]) : new String[0]), "Customer Types");
                        break;
                }
                filterTree.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
    ...
    {//GEN-HEADEREND:event_alertTypeBoxItemStateChanged
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED && alertTypeBox.getSelectedIndex() > 0) {
            ...
            alertDaysField.setEditable("LA".equals(alertType) || "LD".equals(alertType) || "LF".equals(alertType));
            alertDaysField.setText(alertDaysField.isEditable() ? getWorker().checkBlank(getAlert().getDays(), "") : "");
    ...
    {//GEN-HEADEREND:event_copyButtonActionPerformed
        ...
        if ((JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(alertDialog, "Are you sure you want to create copy of this alert?", "Confirm Copy", JOptionPane.YES_NO_OPTION))) {
            try {
                ...
                clone.setCode(getWorker().nextCode(getAlerts(), "A"));
                if (getClient().upsertAlert(clone)) {
                    setAlertTree();
    ...
    private void originatorPHMenuItemActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_originatorPHMenuItemActionPerformed
    {//GEN-HEADEREND:event_originatorPHMenuItemActionPerformed
        // TODO add your handling code here:
        processPlaceHolderAction(evt);
    }//GEN-LAST:event_originatorPHMenuItemActionPerformed

    private void updateTemplate() {
        // TODO add your handling code here:
        DefaultMutableTreeNode selectedTemplateNode = (DefaultMutableTreeNode) templateTree.getLastSelectedPathComponent();
    ...
    private void contraPHMenuItemActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_contraPHMenuItemActionPerformed
    {//GEN-HEADEREND:event_contraPHMenuItemActionPerformed
        // TODO add your handling code here:
        processPlaceHolderAction(evt);
    }//GEN-LAST:event_contraPHMenuItemActionPerformed
    ...
    private void beneficiaryPHMenuItemActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_beneficiaryPHMenuItemActionPerformed
    {//GEN-HEADEREND:event_beneficiaryPHMenuItemActionPerformed
        // TODO add your handling code here:
        processPlaceHolderAction(evt);
    }//GEN-LAST:event_beneficiaryPHMenuItemActionPerformed

    public void setAlertTree() {
        setAlerts(getClient().queryAlerts());
    ...
    private void displayAlert(MXAlert alert) {
        setAlert(alert);
        alertCodeField.setText(getAlert().getCode());
        getWorker().selectBoxValue(alertTypeBox, getAlert().getType());
        ...
        alertDaysField.setText(getWorker().checkBlank(getAlert().getDays(), ""));
    ...
    private void setChargeBox() {
        ...
        TreeMap<String, AXCharge> charges = getClient().queryCharges(ALController.chargeScheme);
    ...
    private javax.swing.JMenuItem beneficiaryPHMenuItem;
    ...
    private javax.swing.JMenuItem contraPHMenuItem;
    ...
    private javax.swing.JMenuItem originatorPHMenuItem;
