...
public class Chunk implements Element {
     ...
     * @param	tabPosition	an X coordinate that will be used as start position
     * for the next Chunk.
     * @since	2.1.2
     */
     ...
     * @param	tabPosition	an X coordinate that will be used as start position
     * for the next Chunk.
     * @param	newline	if true, a newline will be added if the tabPosition has
    ...
    public Chunk(final DrawInterface separator, final float tabPosition, final boolean newline) {
        ...
        setAttribute(TAB, new Object[]{
            separator, new Float(tabPosition), Boolean.valueOf(newline), new Float(0)
        });
    }
     ...
     * text color
     * @param thickness the absolute thickness of the line
     * @param thicknessMul the thickness multiplication factor with the font
     * size
     * @param yPosition the absolute y position relative to the baseline
     ...
     * @param strokeColor the stroke color or <CODE>null</CODE> to follow the
     * text color
     * @return this <CODE>Chunk</CODE>
     */
    public Chunk setTextRenderMode(final int mode, final float strokeWidth,
            final BaseColor strokeColor) {
        return setAttribute(TEXTRENDERMODE, new Object[]{
    ...
    public Chunk setRemoteGoto(final String filename, final String name) {
        return setAttribute(REMOTEGOTO, new Object[]{
            filename, name
        });
    }
