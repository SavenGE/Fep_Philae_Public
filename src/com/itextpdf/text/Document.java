...
public class Document implements DocListener {
    ...
    // membervariables
    /**
     * This constant contains the name of the product. iText is a registered
     * trademark. Please don't change this constant.
     *
     * @since	2.1.6
     */
    private static final String ITEXT = "iText\u00ae";
    /**
     * This constant contains the version number of this iText release. For
     * debugging purposes, we request you NOT to change this constant.
     *
     * @since	2.1.6
     */
    private static final String RELEASE = "5.1.3";
    /**
     * This constant the iText version as shown in the producer line. iText is a
     * product developed by 1T3XT BVBA. 1T3XT requests that you retain the iText
    ...
    /**
     * Returns the iText version as shown in the producer line. iText is a
     * product developed by 1T3XT BVBA. 1T3XT requests that you retain the iText
     * producer line in every PDF that is created or manipulated using iText.
     *
