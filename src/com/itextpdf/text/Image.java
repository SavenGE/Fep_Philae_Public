...
public abstract class Image extends Rectangle implements Indentable, Spaceable {
     ...
     * @param reverseBits reverses the bits in <code>data</code>. Bit 0 is
     * swapped with bit 7 and so on
     ...
     * are CCITT_BLACKIS1, CCITT_ENCODEDBYTEALIGN, CCITT_ENDOFLINE and
     ...
     * @param forceBW if <CODE>true</CODE> the image is treated as black and
     * white
     * @return an object of type <CODE>ImgRaw</CODE>
     * @throws BadElementException on error
     ...
     *
     * @param writer the <CODE>PdfWriter</CODE> object to which the image will
     * be added
     ...
     * a JPEG with a user defined quality.
     *
     * @param cb the <CODE>PdfContentByte</CODE> object to which the image will
     * be added
     * @param awtImage the <CODE>java.awt.Image</CODE> to convert
     * @param quality a float value between 0 and 1
     * @return an object of type <CODE>PdfTemplate</CODE>
    ...
    /**
     * Indicates if the image should be scaled to fit the line when the image
     ...
     *
     * @param scaleToFitLineWhenOverflow true if you want the image to scale to
     * the available width
     * @since iText 5.0.6
     */
