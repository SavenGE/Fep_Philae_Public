...
public class List implements TextElementArray, Indentable {
     ...
     *
     * @param	numbered	a boolean
     * @param	symbolIndent	the indentation that has to be used for the
     * listsymbol
     */
     ...
     *
     * @since	iText 2.1.1
     * @param	postSymbol the String that has to be added after a number or
     * letter in the list symbol.
     */
     ...
     *
     * @since	iText 2.1.1
     * @param	preSymbol the String that has to be added before a number or
     * letter in the list symbol.
     */
