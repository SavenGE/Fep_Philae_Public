 ...
 * {@link #setBorderWidthLeft(float)}or {@link #setBorderColorLeft(BaseColor)}.
 *
 * @see Element
 */
public class Rectangle implements Element {
    ...
    /**
     * Constructs a <CODE>Rectangle</CODE>-object starting from the origin (0,
     * 0) and with a specific rotation (valid values are 0, 90, 180, 270).
     *
     * @param urx	upper right x
     * @param ury	upper right y
...
//	 METHODS TO GET/SET THE BORDER:
    ...
    /**
     * Indicates whether variable width borders are being used. Returns true if <CODE>setBorderWidthLeft, setBorderWidthRight,
     ...
     *
     * @param useVariableBorders indication if the rectangle has variable
     * borders
     */
