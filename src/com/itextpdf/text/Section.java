...
public class Section extends ArrayList<Element> implements TextElementArray, LargeElement, Indentable {
     ...
     * @param	element an element of type <CODE>Paragraph</CODE>,
     * <CODE>List</CODE> or <CODE>Table</CODE>=
     * @throws	ClassCastException if the object is not a <CODE>Paragraph</CODE>,
     * <CODE>List</CODE> or <CODE>Table</CODE>
     ...
     *
     * @param	element an element of type <CODE>Paragraph</CODE>,
     * <CODE>List</CODE>, <CODE>Table</CODE> or another <CODE>Section</CODE>
     * @return	a boolean
     * @throws	ClassCastException if the object is not a <CODE>Paragraph</CODE>,
     ...
     * <CODE>List</CODE>s and/or <CODE>Table</CODE>s
     * @return	<CODE>true</CODE> if the action succeeded, <CODE>false</CODE> if
     * not.
     * @throws	ClassCastException if one of the objects isn't a
     ...
     * {@link Section#NUMBERSTYLE_DOTTED}: 1.2.3. (the default) or
     * {@link Section#NUMBERSTYLE_DOTTED_WITHOUT_FINAL_DOT}: 1.2.3
     *
     ...
     * @param	numbers	an <CODE>ArrayList<Integer></CODE>, containing the numbers
     * of the Parent
     */
    ...
    /**
     * @param addedCompletely true if section was completely added, false
     * otherwise
     * @since	iText 2.0.8
     */
