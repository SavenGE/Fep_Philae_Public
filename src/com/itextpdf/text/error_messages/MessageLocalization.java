...
public final class MessageLocalization {
    ...
    /**
     * Get a message with one parameter as an primitive int. The parameter will
     * replace the string "{1}" found in the message.
     *
     * @param key the key to the message
     ...
     * @since iText 5.0.6
     * @param key the key to the message
     * @param param array of parameter objects, (toString is used to add it to
     * the message)
     * @return the message
     */
