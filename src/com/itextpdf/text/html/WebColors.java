...
public class WebColors extends HashMap<String, int[]> {
     ...
     *
     * @param colStr A non-null, lower case string that might describe an RGB
     * color in hex.
     ...
     * @throws IllegalArgumentException if the String isn't a know
    ...
    public static BaseColor getRGBColor(String name)
        ...
        if (!NAMES.containsKey(name)) // TODO localize this error message.
        {
