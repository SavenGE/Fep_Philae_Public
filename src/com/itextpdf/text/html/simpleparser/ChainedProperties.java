...
public class ChainedProperties {
     ...
     * Returns a value as soon as a match is found or null if the key can't be
     * found.
     *
    ...
    /**
     * Walks through the hierarchy (bottom-up) looking for a property key.
     * Returns true as soon as a match is found or false if the key can't be
     * found.
     *
     * @param	key	the key of the property
    ...
    /**
     * Walks through the hierarchy (bottom-up) and removes the first occurrence
     * of a tag that is encountered.
     *
    ...
    /**
     * If the properties contain a font size, the size may need to be adjusted
     * based on font sizes higher in the hierarchy.
     *
