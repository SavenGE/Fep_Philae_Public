...
/**
 * Factory that produces iText Element objects, based on tags and their
 * properties.
 *
 * @author blowagie
 * @author psoares
...
public class ElementFactory {
    ...
    /**
     * Creates an iText Paragraph object using the properties of the different
     * tags and properties in the hierarchy chain.
     *
     * @param	chain	the hierarchy chain
    ...
    /**
     * Method that does the actual Element creating for the createParagraph and
     * createListItem method.
     *
     * @param paragraph
     * @param chain
     */
    ...
    /**
     * Gets a HyphenationEvent based on the hyphenation entry in the hierarchy
     * chain.
     *
     * @param	chain	the hierarchy chain
