...
/**
 * Implement this interface to process images and to indicate if the image needs
 * to be added or skipped.
 *
 * @since 5.0.6 (renamed)
 */
public interface ImageProcessor {
    ...
    /**
     * Allows you to (pre)process the image before (or instead of) adding it to
     * the DocListener with HTMLWorker.
     *
