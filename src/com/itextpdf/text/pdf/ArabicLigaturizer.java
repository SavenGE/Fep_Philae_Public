 ...
 * Pango ( see http://www.pango.com/ ). Note that the code of this class is the
 * original work of Paulo Soares.
 *
 * @author Paulo Soares
 */
public class ArabicLigaturizer {
    ...
    static char charshape(char s, int which) /* which 0=isolated 1=final 2=initial 3=medial */ {
        int l, r, m;
...
//        return i;
    ...
    // return len
    static void doublelig(StringBuffer string, int level) /* Ok. We have presentation ligatures in our font. */ {
        int len;
