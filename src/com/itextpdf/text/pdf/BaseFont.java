...
public abstract class BaseFont {
    ...
    static class StreamFont extends PdfStream {
         ...
         * @param lengths an array of int that describes the several lengths of
         * each part of the font
     ...
     * @param encoding the encoding to be applied to this font
     * @param embedded true if the font is to be embedded in the PDF
     * @param	forceRead	in some cases (TrueTypeFont, Type1Font), the full font
     * file will be read and kept in memory if forceRead is true
     * @return returns a new font. This font may come from the cache
     * @throws DocumentException the font is invalid
     * @throws IOException the font file could not be read
     * @since	2.1.5
     ...
     * @param encoding the encoding to be applied to this font
     * @param embedded true if the font is to be embedded in the PDF
     * @param cached true if the font comes from the cache or is added to the
     ...
     * @param ttfAfm the true type font or the afm in a byte array
     * @param pfb the pfb in a byte array
     * @param noThrow if true will not throw an exception if the font is not
     * recognized and will return null, if false will throw an exception if the
     * font is not recognized. Note that even if true an exception may be thrown
     * in some circumstances. This parameter is useful for FontFactory that may
     * have to check many invalid font names before finding the right one
     * @return returns a new font. This font may come from the cache but only if
     * cached is true, otherwise it will always be created new
     * @throws DocumentException the font is invalid
     * @throws IOException the font file could not be read
...
// ia>
     ...
     *
     * @param key the full name of the resource
     * @param loader the ClassLoader to load the resource or null to try the
     * ones available
     * @return the <CODE>InputStream</CODE> to get the resource or
     * <CODE>null</CODE> if not found
     */
