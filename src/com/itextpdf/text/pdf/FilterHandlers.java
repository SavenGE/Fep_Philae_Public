...
/**
 * Encapsulates filter behavior for PDF streams. Classes generally interace with
 * this using the static getDefaultFilterHandlers() method, then obtain the
 * desired {@link FilterHandler} via a lookup.
 *
 * @since 5.0.4
 */
