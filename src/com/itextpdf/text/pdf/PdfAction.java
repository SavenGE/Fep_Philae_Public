...
public class PdfAction extends PdfDictionary {
     ...
     *
     * @param application the application to be launched or the document to be
     * opened or printed.
     * @param parameters (Windows-specific) A parameter string to be passed to
     * the application. It can be <CODE>null</CODE>.
     * @param operation (Windows-specific) the operation to perform: "open" -
     * Open a document, "print" - Print a document. It can be <CODE>null</CODE>.
     * @param defaultDir (Windows-specific) the default directory in standard
     * DOS syntax. It can be <CODE>null</CODE>.
     */
     ...
     * @param isName if true sets the destination as a name, if false sets it as
     * a String
     * @return a GoTo action
     */
     ...
     *
     * @param filename	the root document of the target (null if the target is in
     * the same document)
     * @param dest the named destination
     * @param isName if true sets the destination as a name, if false sets it as
     * a String
     ...
     * @param dest	the destination inside the target document, can be of type
     * PdfDestination, PdfName, or PdfString
     * @param newWindow	if true, the destination document should be opened in a
     * new window
     * @return a GoToE action
     */
     ...
     * content groups.
     *
     * @param state an array consisting of any number of sequences beginning
     * with a <CODE>PdfName</CODE> or <CODE>String</CODE> (ON, OFF, or Toggle)
     * followed by one or more optional content group dictionaries
     * <CODE>PdfLayer</CODE> or a <CODE>PdfIndirectReference</CODE> to a
     * <CODE>PdfLayer</CODE>.<br>
     ...
     * </ul>
     * @param preserveRB if <CODE>true</CODE>, indicates that radio-button state
     * relationships between optional content groups (as specified by the
     * RBGroups entry in the current configuration dictionary) should be
     * preserved when the states in the <CODE>state</CODE> array are applied.
     * That is, if a group is set to ON (either by ON or Toggle) during
     * processing of the <CODE>state</CODE> array, any other groups belong to
     * the same radio-button group are turned OFF. If a group is set to OFF,
     * there is no effect on other groups.<br>
     * If <CODE>false</CODE>, radio-button state relationships, if any, are
     * ignored
     * @return the action
     */
