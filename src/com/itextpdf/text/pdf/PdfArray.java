...
public class PdfArray extends PdfObject implements Iterable<PdfObject> {
     ...
     * @throws IndexOutOfBoundsException if the specified index is larger than
     * the last position currently set, plus 1.
     * @since 2.1.5
     */
    ...
    /**
     * @return an iterator that iterates over the {@link PdfObject}s in this
     * PdfArray.
     */
