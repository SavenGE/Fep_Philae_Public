...
public class PdfChunk {
     ...
     * @param action the <CODE>PdfAction</CODE> if the <CODE>Chunk</CODE> comes
    ...
    PdfChunk(Chunk chunk, PdfAction action) {
        ...
        if (baseFont == null) {
            ...
            if ((style & Font.ITALIC) != 0) {
                attributes.put(Chunk.SKEW, new float[]{
                    0, ITALIC_ANGLE
                });
            }
        }
    ...
    void adjustLeft(float newValue) {
        ...
        if (o != null) {
            attributes.put(Chunk.TAB, new Object[]{
