...
/**
 * Wrapper class for PdfCopy and PdfSmartCopy. Allows you to concatenate
 * existing PDF documents with much less code.
 */
public class PdfConcatenate {
    ...
    /**
     * Gets the PdfCopy instance so that you can add bookmarks or change
     * preferences before you close PdfConcatenate.
     */
    ...
    /**
     * Opens the document (if it isn't open already). Opening the document is
     * done implicitly.
     */
    public void open() {
        if (!document.isOpen()) {
