...
public class PdfContentByte {
    ...
    /**
     * Adds the content of another <CODE>PdfContentByte</CODE>-object to this
     * object.
     *
     ...
     * color space), and sets the gray tint to use for filling paths.</P>
     *
     ...
     * <P>
     * Sets the color space to <B>DeviceGray</B> (or the <B>DefaultGray</B>
     * color space), and sets the gray tint to use for stroking paths.</P>
     *
     * @param gray a value between 0 (black) and 1 (white)
     */
     ...
     * space), and sets the color to use for filling paths.</P>
     * <P>
     * Following the PDF manual, each operand must be a number between 0
     * (minimum intensity) and 1 (maximum intensity).</P>
     *
     * @param red the intensity of red. A value between 0 and 1
     * @param green the intensity of green. A value between 0 and 1
     * @param blue the intensity of blue. A value between 0 and 1
     ...
     * <P>
     * Sets the color space to <B>DeviceRGB</B> (or the <B>DefaultRGB</B> color
     * space), and sets the color to use for stroking paths.</P>
     * <P>
     * Following the PDF manual, each operand must be a number between 0
     ...
     * color space), and sets the color to use for filling paths.</P>
     * <P>
     * Following the PDF manual, each operand must be a number between 0 (no
     * ink) and 1 (maximum ink).</P>
     *
     * @param cyan the intensity of cyan. A value between 0 and 1
     * @param magenta the intensity of magenta. A value between 0 and 1
     * @param yellow the intensity of yellow. A value between 0 and 1
     ...
     * <P>
     * Sets the color space to <B>DeviceCMYK</B> (or the <B>DefaultCMYK</B>
     * color space), and sets the color to use for stroking paths.</P>
     * <P>
     * Following the PDF manual, each operand must be a number between 0
     * (miniumum intensity) and 1 (maximum intensity).
     *
     ...
     * {@link com.itextpdf.text.Rectangle#isUseVariableBorders() Rectangle.isUseVariableBorders}
     * = true.
     *
     ...
     * @throws DocumentException if the <CODE>Image</CODE> does not have
     * absolute positioning
     */
     ...
     *
     * @param image the <CODE>Image</CODE> object
     * @param inlineImage <CODE>true</CODE> to place this image inline,
     ...
     * vertical distance between the baselines of adjacent lines of text.</P>
     *
     ...
     *
     * @param alignment the alignment can be ALIGN_CENTER, ALIGN_RIGHT or
     * ALIGN_LEFT
     ...
     * @param xstep the desired horizontal spacing between pattern cells. May be
     * either positive or negative, but not zero.
     * @param ystep the desired vertical spacing between pattern cells. May be
     * either positive or negative, but not zero.
     ...
     * Manual version 1.3' section 8.5.2.1 (page 331).</P>
     * <P>
     * Following the PDF manual, each operand must be a number between 0 (no
     * ink) and 1 (maximum ink). This method however accepts only integers
     * between 0x00 and 0xFF.</P>
     *
     ...
     * Following the PDF manual, each operand must be a number between 0
     * (minimum intensity) and 1 (maximum intensity). This method however
     * accepts only integers between 0x00 and 0xFF.</P>
     *
     ...
     * @param tint the tint for the spot color. 0 is no color and 1 is 100%
     * color
     */
     ...
     * @param destination the <CODE>PdfDestination</CODE> with the jump
     * coordinates
     * @return <CODE>true</CODE> if the local destination was added,
     * <CODE>false</CODE> if a local destination with the same name already
     * exists
     */
     ...
     * @param height the height of the panel
     * @param fontMapper the mapping from awt fonts to <CODE>BaseFont</CODE>
     * @param convertImagesToJPEG converts awt images to jpeg before inserting
     * in pdf
     ...
     * @param obj the colorspace. A <CODE>null</CODE> or <CODE>PdfNull</CODE>
     ...
     * @param inline <CODE>true</CODE> to include the property in the content or
     * <CODE>false</CODE> to include the property in the resource dictionary
