/*
 * $Id: PdfDestination.java 4860 2011-05-09 09:57:46Z redlab_b $
 *
...
public class PdfDestination extends PdfArray {
     ...
     * the window. If the <VAR>type</VAR> equals <VAR>FITH</VAR>
     * or <VAR>FITV</VAR> the width / height of the entire page will fit the
     * window and the parameter will specify the y / x coordinate of the top /
     * left edge. In all other cases the type will be set to
     * <VAR>FITH</VAR>.
     *
     * @param	type	the destination type
     ...
     * instance the values returned by SimpleNamedDestination: "Fit", "XYZ 36
     * 806 0",...
     *
