...
public class PdfEncodings {
     ...
     *
     * @param name the name of the cmap to clear or all the cmaps if the empty
     * string
     */
     ...
     * @param newline the sequences to be replaced by a newline in the resulting
     ...
     * 16 bit Unicode.</p>
     * The font to use this result must use the encoding "Identity-H" or
     * "Identity-V".</p>
     ...
     *
     * @param name the name of the encoding. The encoding recognition is case
     * insensitive
