...
public final class PdfEncryptor {
     ...
     * @param strength128Bits <code>true</code> for 128 bit key length,
     * <code>false</code> for 40 bit key length
     * @param newInfo an optional <CODE>String</CODE> map to add or change the
     * info dictionary. Entries with <CODE>null</CODE> values delete the key in
     * the original info dictionary
     * @throws DocumentException on error
     * @throws IOException on error
     ...
     * @param reader the read PDF
     * @param os the output destination
     * @param type the type of encryption. It can be one of
     ...
     * @param userPassword the user password. Can be null or empty
     * @param ownerPassword the owner password. Can be null or empty
     * @param permissions the user permissions values delete the key in the
