...
public class PdfFileSpecification extends PdfDictionary {
     ...
     * @param fileStore the byte array with the file. If it is not
     * <CODE>null</CODE> it takes precedence over <CODE>filePath</CODE>
     ...
     * @param fileStore the byte array with the file. If it is not
     * <CODE>null</CODE> it takes precedence over <CODE>filePath</CODE>
     * @param compressionLevel	the compression level to be used for compressing
     * the file it takes precedence over <CODE>filePath</CODE>
     * @throws IOException on error
     * @return the file specification
     * @since	2.1.3
     */
     ...
     * @param fileStore the byte array with the file. If it is not
     * <CODE>null</CODE> it takes precedence over <CODE>filePath</CODE>
     * @param compress sets the compression on the data. Multimedia content will
     ...
     * @param fileParameter the optional extra file parameters such as the
     ...
     * @param unicode	if true, the filename is UTF-16BE encoded; otherwise
