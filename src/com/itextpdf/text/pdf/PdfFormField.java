...
public class PdfFormField extends PdfAnnotation {
    ...
    /**
     * Sets the rich value for this field. It is suggested that the regular
     * value of this field be set to an equivalent value. Rich text values are
     * only supported since PDF 1.5, and require that the FF_RV flag be set. See
     * PDF Reference chapter 12.7.3.4 for details.
     *
