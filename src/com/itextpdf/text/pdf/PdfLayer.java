...
public class PdfLayer extends PdfDictionary implements PdfOCG {
     ...
     *
     * @param creator a text string specifying the application that created the
     * group
     * @param subtype a string defining the type of content controlled by the
     * group. Suggested values include but are not limited to <B>Artwork</B>,
     * for graphic-design or publishing applications, and
     * <B>Technical</B>, for technical designs such as building plans or
     * schematics
     */
     ...
     * group
     *
     * @param lang a language string which specifies a language and possibly a
     * locale (for example,
     * <B>es-MX</B> represents Mexican Spanish)
     * @param preferred used by viewer applications when there is a partial
     * match but no exact match between the system language and the language
     ...
     *
     * @param min the minimum recommended magnification factors at which the
     * group should be ON. A negative value will set the default to 0
     * @param max the maximum recommended magnification factor at which the
     * group should be ON. A negative value will set the largest possible
     * magnification supported by the viewer application
     */
     ...
     *
     * @param subtype a name specifying the kind of content controlled by the
     * group; for example,
     * <B>Trapping</B>, <B>PrintersMarks</B> and <B>Watermark</B>
     * @param printstate indicates that the group should be set to that state
     * when the document is printed from a viewer application
     */
     ...
     *
     * @param pe one of the following names: "HF" (Header Footer), "FG"
     * (Foreground), "BG" (Background), or "L" (Logo).
     * @since 5.0.2
     */
    ...
    /**
     * One of more users for whom this optional content group is primarily
     * intended.
     *
     * @param type should be "Ind" (Individual), "Ttl" (Title), or "Org"
     * (Organization).
