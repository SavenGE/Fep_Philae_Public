/*
 * $Id: PdfLayerMembership.java 4784 2011-03-15 08:33:00Z blowagie $
 *
 ...
 * when the group is <B>ON</B>
 * and invisible when it is <B>OFF</B>. To express more complex visibility
 * policies, content should not declare itself to belong to an optional content
 * group directly, but rather to an optional content membership dictionary
...
public class PdfLayerMembership extends PdfDictionary implements PdfOCG {
    ...
    /**
     * Sets the visibility expression for content belonging to this membership
     * dictionary.
     *
