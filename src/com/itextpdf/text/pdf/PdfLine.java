...
public class PdfLine {
     ...
     * @param alignment	the alignment of the line
     * @param newlineSplit	was the line splitted (or does the paragraph end with
     * this line)
     ...
     * a <CODE>PdfChunk</CODE> containing the part of the chunk that could not
     ...
     * (for instance when there are images in the chunk and the leading has to
    ...
    /**
     * Gets the number of separators in the line. Returns -1 if there's a tab in
     * the line.
     *
