/*
 * $Id: PdfNameTree.java 4784 2011-03-15 08:33:00Z blowagie $
 *
...
public class PdfNameTree {
     ...
     * and the value is a <CODE>PdfObject</CODE>. Note that although the keys
     * are strings only the lower byte is used and no check is made for chars
     * with the same lower byte and different upper byte. This will generate a
     * wrong tree name.
