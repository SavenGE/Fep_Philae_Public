...
public class PdfPKCS7 {
     ...
     * a <CODE>Object[]{cert,error}</CODE> where <CODE>cert</CODE> is the failed
     * certificate and <CODE>error</CODE> is the error message
     */
        ...
        try {
            ...
            for (int i = 0; i < AccessDescriptions.size(); i++) {
                ...
                if (AccessDescription.size() != 2) {
                    continue;
                } else if (AccessDescription.getObjectAt(0) instanceof DERObjectIdentifier && ((DERObjectIdentifier) AccessDescription.getObjectAt(0)).getId().equals("1.3.6.1.5.5.7.48.1")) {
