/*
 * $Id: PdfPTableEvent.java 4784 2011-03-15 08:33:00Z blowagie $
 *
...
public interface PdfPTableEvent {
     ...
     * @param widths an array of arrays with the cells' x positions. It has the
     * length of the number of rows
     * @param heights an array with the cells' y positions. It has a length of
