...
public class PdfSignatureAppearance {
     ...
     * <CODE>RenderingMode.GRAPHIC</CODE> or
     * <CODE>RenderingMode.GRAPHIC_AND_DESCRIPTION</CODE>.
     *
     * @param signatureGraphic image rendered. If <CODE>null</CODE> the mode is
     * defaulted to <CODE>RenderingMode.DESCRIPTION</CODE>
     */
     ...
     * <CODE>null</CODE> or not set a standard description will be used
     */
     ...
     * <CODE>null</CODE> or not set the description "Signature Not Verified"
     * will be used
     */
     ...
     * <CODE>null</CODE> or have zero width or height for invisible signatures
     */
     ...
     * @param crlList the certificate revocation list. It may be
     * <CODE>null</CODE>
     * @param filter the cryptographic filter type. It can be SELF_SIGNED,
     ...
     * <p>
     * Consult
     * <A HREF="http://partners.adobe.com/asn/developer/pdfs/tn/PPKAppearances.pdf">PPKAppearances.pdf</A>
     * for further details.
     *
     ...
     * <CODE>null</CODE> if the <CODE>digest</CODE> is also <CODE>null</CODE>.
     * If the <CODE>digest</CODE> is not <CODE>null</CODE> then it may be "RSA"
     * or "DSA"
     */
     ...
     *
     * @param exclusionSizes a <CODE>HashMap</CODE> with names and sizes to be
     * excluded in the signature calculation. The key is a <CODE>PdfName</CODE>
     ...
     *
     * @param update a <CODE>PdfDictionary</CODE> with the key/value that will
     * fill the holes defined in {@link #preClose(HashMap)}
     * @throws DocumentException on error
     * @throws IOException on error
     */
     ...
     *
     * @param acro6Layers if <code>true</code> only the layers n0 and n2 will be
     * present
     */
