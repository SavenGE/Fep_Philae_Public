 ...
 * <B>stream</B>, followed by zero or more lines of characters, followed by the
 * keyword <B>endstream</B>.<BR>
...
public class PdfStream extends PdfDictionary {
     ...
     * <
     * pre>
     * InputStream in = ...; PdfStream stream = new PdfStream(in, writer);
     * stream.flateCompress(); writer.addToBody(stream); stream.writeLength();
     * in.close();
     * </pre>
     *
     ...
     * Compresses the stream.
     *
     * @param compressionLevel the compression level (0 = best speed, 9 = best
...
//    }
    ...
    /**
     * @see
     * com.itextpdf.text.pdf.PdfDictionary#toPdf(com.itextpdf.text.pdf.PdfWriter,
