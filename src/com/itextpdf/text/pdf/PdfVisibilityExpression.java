...
/**
 * An array specifying a visibility expression, used to compute visibility of
 * content based on a set of optional content groups.
 *
 * @since 5.0.2
 */
public class PdfVisibilityExpression extends PdfArray {
    ...
    /**
     * @see
     * com.itextpdf.text.pdf.PdfArray#addFirst(com.itextpdf.text.pdf.PdfObject)
     */
    @Override
