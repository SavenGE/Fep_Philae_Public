...
//  [F1] PdfEncryptionSettings interface
    ...
    /**
     * @see
     * com.itextpdf.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(byte[],
     * byte[], int, int)
     */
    ...
    /**
     * @see
     * com.itextpdf.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(java.security.cert.Certificate[],
     * int[], int)
     */
    ...
    PdfName addDirectTemplateSimple(PdfTemplate template, final PdfName forcedName) {
        ...
        try {
            if (obj == null) {
                ...
                formXObjects.put(ref, new Object[]{
                    name, template
                });
            } else {
                name = (PdfName) obj[0];
    ...
    PdfObject[] addSimpleExtGState(final PdfDictionary gstate) {
        if (!documentExtGState.containsKey(gstate)) {
            ...
            documentExtGState.put(gstate, new PdfObject[]{
                new PdfName("GS" + (documentExtGState.size() + 1)), getPdfIndirectReference()
            });
        }
    ...
    PdfObject[] addSimpleProperty(final Object prop, final PdfIndirectReference refi) {
        if (!documentProperties.containsKey(prop)) {
            ...
            documentProperties.put(prop, new PdfObject[]{
                new PdfName("Pr" + (documentProperties.size() + 1)), refi
            });
        }
