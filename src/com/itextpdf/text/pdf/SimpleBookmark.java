 ...
 * have a "Color" key with a value of three floats with values in the range 0.0
 * to 1.0 separated by spaces. The key "Open" can have the values "true" or
 * "false" and signals the open status of the children. It's "true" by default.
 * <p>
...
public final class SimpleBookmark implements SimpleXMLDocHandler {
     ...
     * @param pageRange the page ranges, always in pairs. It can be
     * <CODE>null</CODE> to include all the pages
     */
    @SuppressWarnings("unchecked")
     ...
     * <
     * pre>
     * &lt;?xml version='1.0' encoding='UTF-8'?&gt; &lt;!ELEMENT Title
     * (#PCDATA|Title)*&gt; &lt;!ATTLIST Title Action CDATA #IMPLIED Open CDATA
     * #IMPLIED Page CDATA #IMPLIED URI CDATA #IMPLIED File CDATA #IMPLIED Named
     * CDATA #IMPLIED NamedN CDATA #IMPLIED NewWindow CDATA #IMPLIED Style CDATA
     * #IMPLIED Color CDATA #IMPLIED &gt; &lt;!ELEMENT Bookmark (Title)*&gt;
     * </pre>
     *
     * @param list the bookmarks
