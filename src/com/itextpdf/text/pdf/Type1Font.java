...
class Type1Font extends BaseFont {
     ...
     *
     * @param ttfAfm the AFM file if the input is made with a <CODE>byte</CODE>
     * array
     * @param pfb the PFB file if the input is made with a <CODE>byte</CODE>
     * array
     * @param afmFile the name of one of the 14 built-in fonts or the location
     * of an AFM file. The file must end in '.afm'
    ...
    public void process(RandomAccessFileOrArray rf) throws DocumentException, IOException {
        ...
        while ((line = rf.readLine()) != null) {
            ...
            if (ident.equals("KPX")) {
                ...
                if (relates == null) {
                    KernPairs.put(first, new Object[]{
                        second, width
                    });
                } else {
