...
public class LineSeparator extends VerticalPositionMark {
     ...
     * @param percentage	the width of the line as a percentage of the available
     * page width
     * @param lineColor	the color of the line
     * @param align	the alignment
     * @param offset	the offset of the line relative to the current baseline
    ...
    /**
     * @see
     * com.itextpdf.text.pdf.draw.DrawInterface#draw(com.itextpdf.text.pdf.PdfContentByte,
