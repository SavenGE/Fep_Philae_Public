...
public class ImageRenderInfo {
    ...
    /**
     * The coordinate transformation matrix that was in effect when the image
     * was rendered
     */
    ...
    /**
     * the image object to be rendered, if it has been parsed already. Null
     * otherwise.
     */
    ...
    /**
     * Create an ImageRenderInfo object based on an XObject (this is the most
     * common way of including an image in PDF)
     *
     * @param ctm the coordinate transformation matrix at the time the image is
     * rendered
    ...
    /**
     * Create an ImageRenderInfo object based on inline image data. This is
     * nowhere near completely thought through and really just acts as a
     * placeholder.
     *
     * @param ctm the coordinate transformation matrix at the time the image is
     * rendered
    ...
    /**
     * @return a vector in User space representing the start point of the
     * xobject
     */
    ...
    /**
     * @return The coordinate transformation matrix active when this image was
     * rendered. Coordinates are in User space.
     * @since 5.0.3
     */
