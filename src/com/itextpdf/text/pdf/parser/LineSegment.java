...
/**
 * Represents a line segment in a particular coordinate system. This class is
 * immutable.
 *
 * @since 5.0.2
 */
public class LineSegment {
    ...
    /**
     * Computes the bounding rectangle for this line segment. The rectangle has
     * a rotation 0 degrees with respect to the coordinate system that the line
     * system is in. For example, if a line segment is 5 unit long and sits at a
     * 37 degree angle from horizontal, the bounding rectangle will have origin
     * of the lower left hand end point of the segment, with width = 4 and
     * height = 3.
     *
