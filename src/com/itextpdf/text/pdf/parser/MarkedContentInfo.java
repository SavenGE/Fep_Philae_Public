/*
 * $Id: MarkedContentInfo.java 4784 2011-03-15 08:33:00Z blowagie $
 *
...
public class MarkedContentInfo {
    ...
    /**
     * Gets the MCID value If the Marked Content contains an MCID entry, returns
     * that value. Otherwise, a {@link NullPointerException} is thrown.
     *
     * @return the MCID value
     * @throws NullPointerException if there is no MCID (see
     * {@link MarkedContentInfo#hasMcid()})
     */
    public int getMcid() {
