...
public class PdfImageObject {
    ...
    public static enum ImageBytesType {
        ...
        /**
         * @param fileExtension the recommended file extension for use with data
         * of this type (for example, if the bytes were just saved to a file,
    ...
    /**
     * A filter that does nothing, but keeps track of the filter type that was
     * used
     *
     * @since 5.0.4
     */
    ...
    /**
     * The decoded image bytes (after applying filters), or the raw image bytes
     * if unable to decode
     */
    ...
    /**
     * Creats a PdfImage object using an explicitly provided dictionary and
     * image bytes
     *
     ...
     * @param allowIndexed whether indexed color spaces will be resolved (used
     * for recursive call)
     * @throws IOException if there is a problem with reading from the
     * underlying stream
     */
    ...
    /**
     * decodes the bytes currently captured in the streamBytes and replaces it
     * with an image representation of the bytes (this will either be a png or a
     * tiff, depending on the color depth of the image)
     *
     * @throws IOException
     */
    ...
    /**
     * @return the bytes of the image (the format will be as specified in
     * {@link PdfImageObject#getImageBytesType()}
     * @throws IOException
     * @since 5.0.4
     */
