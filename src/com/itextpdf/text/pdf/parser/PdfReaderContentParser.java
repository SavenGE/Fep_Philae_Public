 ...
 * PdfReader through a specified RenderListener.
 *
 * @since 5.0.2
 */
public class PdfReaderContentParser {
    ...
    /**
     * Processes content from the specified page number using the specified
     * listener
     *
     * @param <E> the type of the renderListener - this makes it easy to chain
     * calls
