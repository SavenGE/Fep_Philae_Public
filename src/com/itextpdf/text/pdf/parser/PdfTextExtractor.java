...
public final class PdfTextExtractor {
     ...
     * @throws IOException if any operation fails while reading from the
     * provided PdfReader
     * @since 5.0.2
     */
     ...
     * <p>
     * <strong>Note:</strong> the default strategy is subject to change. If
     * using a specific strategy is important, use
     * {@link PdfTextExtractor#getTextFromPage(PdfReader, int, TextExtractionStrategy)}
     *
     * @param reader the reader to extract text from
     * @param pageNumber the page to extract text from
     * @return the extracted text
