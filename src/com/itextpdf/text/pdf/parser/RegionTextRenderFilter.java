...
/**
 * A {@link RenderFilter} that only allows text within a specified rectangular
 * region
 *
 * @since 5.0.1
 */
public class RegionTextRenderFilter extends RenderFilter {
     ...
     * Constructs a filter
     *
     * @param filterRect the rectangle to filter text against. Note that this is
    ...
    /**
     * @see
     * com.itextpdf.text.pdf.parser.RenderFilter#allowText(com.itextpdf.text.pdf.parser.TextRenderInfo)
     */
