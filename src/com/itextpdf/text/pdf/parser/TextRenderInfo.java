 ...
 * display/evaluate text render operations.
 * <br><br>
...
public class TextRenderInfo {
     ...
     * @param gs the graphics state (note: at this time, this is not immutable,
     * so don't cache it)
    ...
    /**
     * Checks if the text belongs to a marked content sequence with a given
     * mcid.
     *
    ...
    /**
     * Gets the ascentline for the text (i.e. the line that represents the
     * topmost extent that a string of the current font could have)
     *
    ...
    /**
     * Gets the descentline for the text (i.e. the line that represents the
     * bottom most extent that a string of the current font could have)
     *
     ...
     * width for a standard space character \u0020, we also attempt to use the
     * width of \u00A0 (a non-breaking space in many fonts)
     *
