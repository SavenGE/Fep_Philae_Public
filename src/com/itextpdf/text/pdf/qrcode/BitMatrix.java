 ...
 * ordering is always x, y. The origin is at the top-left.</p>
 *
 * <p>
 ...
 * copy out a row into a BitArray very efficiently.</p>
 *
 * <p>
 ...
 * compatible with BitArray's implementation.</p>
 *
 * @author Sean Owen
...
public final class BitMatrix {
    ...
    /**
     * <p>
     * Gets the requested bit, where true means black.</p>
     *
    ...
    /**
     * <p>
     * Sets a square region of the bit matrix to true.</p>
     *
    ...
    /**
     * This method is for compatibility with older code. It's only logical to
     * call if the matrix is square, so I'm throwing if that's not the case.
     *
