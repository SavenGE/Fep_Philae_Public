 ...
 * the bottom 8 bits are really used.</p>
 *
 * @author Sean Owen
 * @since 5.0.2
 */
public final class GF256 {
     ...
     *
     * @param primitive irreducible polynomial whose coefficients are
     * represented by the bits of an int, where the least-significant bit
