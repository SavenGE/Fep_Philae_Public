 ...
 * repeatedly. See ExtensionLevel 3 p80
 *
...
public class RichMediaAnimation extends PdfDictionary {
    ...
    /**
     * Constructs a RichMediaAnimation. Also sets the animation style described
     * by this dictionary. Valid values are None, Linear, and Oscillating.
     *
     * @param	subtype	possible values are PdfName.NONE, PdfName.LINEAR,
     * PdfName.OSCILLATING
     */
    ...
    /**
     * Sets the speed to be used when running the animation. A value greater
     * than one shortens the time it takes to play the animation, or effectively
