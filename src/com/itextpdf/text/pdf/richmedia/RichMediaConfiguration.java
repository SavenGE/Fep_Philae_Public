...
/**
 * The RichMediaConfiguration dictionary describes a set of instances that are
 * loaded for a given scene configuration. The configuration to be loaded when
 * an annotation is activated is referenced by the Configuration key in the
 * RichMediaActivation dictionary specified in the RichMediaSettings dictionary.
