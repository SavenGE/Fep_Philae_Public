...
/**
 * The RichMediaInstance dictionary, referenced by the Instances entry of the
 * RichMediaConfiguration, describes a single instance of an asset with settings
 * to populate the artwork of an annotation. See ExtensionLevel 3 p88
 *
...
public class RichMediaInstance extends PdfDictionary {
    ...
    /**
     * Creates a RichMediaInstance. Also specifies the content type for the
     * instance. Valid values are 3D, Flash, Sound, and Video. The subtype must
     * match the asset file type of the instance.
     *
     * @param	subtype	possible values are: PdfName._3D, PdfName.FLASH,
     * PdfName.SOUND, and PdfName.VIDEO.
     */
    ...
    /**
     * Sets a dictionary that shall be an indirect object reference to a file
     * specification dictionary that is also referenced in the Assets name tree
     * of the content of the annotation.
     *
