...
/**
 * Dictionary containing parameters related to an active Flash subtype in a
 * RichMediaInstance dictionary. See ExtensionLevel 3 p90
 *
 * @since	5.0.0
 */
public class RichMediaParams extends PdfDictionary {
    ...
    /**
     * Sets a text string containing formatted name value pairs passed to the
     * Flash Player context when activated.
     *
     ...
     * Sets the binding.
     *
     * @param	binding	possible values: PdfName.NONE, PdfName.FOREGROUND,
     * PdfName.BACKGROUND, PdfName.MATERIAL
     */
    ...
    /**
     * Stores the material name that content is to be bound to. Required if
     * Binding value is Material.
     *
    ...
    /**
     * Sets an array of CuePoint dictionaries containing points in time within a
     * Flash animation.
     *
    ...
    /**
     * A text string used to store settings information associated with a Flash
     * RichMediaInstance. It is to be stored and loaded by the scripting run
     * time.
     *
