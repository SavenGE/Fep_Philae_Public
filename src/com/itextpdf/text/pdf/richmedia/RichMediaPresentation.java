 ...
 * annotation and user interface elements are to be visually laid out and drawn.
...
public class RichMediaPresentation extends PdfDictionary {
    ...
    /**
     * A RichMediaWindow Dictionary that describes the size and position of the
     * floating user interface window when the value for Style is set to
     * Windowed.
     *
    ...
    /**
     * Set a flag that indicates whether the page content is displayed through
     * the transparent areas of the rich media content (where the alpha value is
     * less than 1.0). If true, the rich media artwork is composited over the
     * page content using an alpha channel. If false, the rich media artwork is
     ...
     * user interface element. If true, the navigation pane is visible when the
     * content is initially activated. If false, the navigation pane is not
    ...
    /**
     * Sets a flag that indicates the default behavior of an interactive toolbar
     * associated with this annotation. If true, a toolbar is displayed when the
     * annotation is activated and given focus. If false, a toolbar is not
     * displayed by default.
     *
     ...
     * annotation is passed to the media player run time or is handled by the
     * conforming reader. If false, the conforming reader handles the context
     * click. If true, the conforming reader's context menu is not visible, and
     * the user sees the context menu and any custom items generated by the
     * media player run time.
     *
