 ...
 * floating window presented to the user. It is used only if Style is set to
 * Windowed. See ExtensionLevel 3 p84
 *
...
public class RichMediaWindow extends PdfDictionary {
    ...
    /**
     * Creates a dictionary that can be used for the HEIGHT and WIDTH entries of
     * the RichMediaWindow dictionary.
     *
     * @param	d	the default
    ...
    /**
     * Sets a RichMediaPosition dictionary describing the position of the
     * RichMediaWindow.
     *
