...
/**
 * The value of the GCS or DCS entry of a geospatial measure dictionary. Can be
 * a GeographicCoordinateSystem or a ProjectedCoordinateSystem.
 *
 * @since 5.1.0
 */
public abstract class CoordinateSystem extends PdfDictionary {
    ...
    /**
     * Creates a specific type of CoordinateSystem: GEOGCS
     * (GeographicCoordinateSystem) or PROJCS (ProjectedCoordinateSystem).
     */
