...
public class MeasureGeospatial extends Measure {
    ...
    /**
     * Gets the subtype. In this case RL for a rectalinear coordinate system.
     */
    PdfName getSubType() {
        return PdfName.GEO;
    }
    ...
    /**
     * Optional coordinate system that allows a document to be authored to
     * display values in a coordinate system other than that associated with the
     * source data. For example, a map may be created in a state plane
     * coordinate system based on a 1927 datum, but it is possible to display
     * its latitude and longitude values in the WGS84 datum corresponding to
