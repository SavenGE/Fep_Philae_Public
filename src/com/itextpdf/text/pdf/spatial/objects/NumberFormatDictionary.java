...
/**
 * A dictionary that represents a specific unit of measurement (such as miles or
 * feet). It contains information about how each unit shall be expressed in text
 * and factors for calculating the number of units.
 *
 * @since 5.1.0
 */
public class NumberFormatDictionary extends PdfDictionary {
     ...
     * which entry in the RectilinearMeasure references the NumberFormat array.
     *
     * @param n
     */
     ...
     * numerical values. An empty string indicates that no text shall be
     * added.<br />
     * Default value: COMMA "\u002C"
     *
     * @param rt
    ...
    /**
     * A name indicating the position of the label specified by setLabel with
     * respect to the calculated unit value. The characters specified by
     * setLabelLeftString and setLabelRightString shall be concatenated before
     * considering this entry. Default value: suffix.
     *
