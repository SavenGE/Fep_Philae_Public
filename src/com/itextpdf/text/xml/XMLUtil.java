...
public class XMLUtil {
    ...
    /**
     * Unescapes a String, replacing &#nn;, &lt;, &gt;, &amp;, &quot;, and &apos
    ...
    /**
     * Unescapes 'lt', 'gt', 'apos', 'quote' and 'amp' to the corresponding
     * character values.
     *
    ...
    /**
     * Looks for a character in a character array, starting from a certain
     * position
     *
     * @param needle	the character you're looking for
     * @param haystack	the character array
     * @param start	the start position
     * @return	the position where the character was found, or -1 if it wasn't
     * found.
     */
