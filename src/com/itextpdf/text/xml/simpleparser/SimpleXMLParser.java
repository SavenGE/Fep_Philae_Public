...
/**
 * A simple XML. This parser is, like the SAX parser, an event based parser, but
...
public final class SimpleXMLParser {
     ...
     * processes the tag.
     *
     * @param start	if true we are dealing with a tag that has just been opened;
     ...
     * @param r the document. The encoding is already resolved. The reader is
     * not closed
     * @param html
     ...
     *
     * @param doc the document handler
     * @param in the document. The encoding is deduced from the stream. The
