/*
 * $Id: XmpMMSchema.java 4784 2011-03-15 08:33:00Z blowagie $
 *
...
public class XmpMMSchema extends XmpSchema {
     ...
     * the steps taken to make the changes from the previous version to this
     * one. The list should be at an abstract level; it is not intended to be an
