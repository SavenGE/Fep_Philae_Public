 ...
 * {@link ServletRequest#startAsync(ServletRequest, ServletResponse)}) has
...
public class AsyncEvent {
    ...
    /**
     * Constructs an AsyncEvent from the given AsyncContext, ServletRequest, and
     * ServletResponse.
     *
     * @param context the AsyncContex to be delivered with this AsyncEvent
     ...
     *
     * <p>
     * If the AsyncListener to which this AsyncEvent is being delivered was
     * added using {@link AsyncContext#addListener(AsyncListener,
     * ServletRequest, ServletResponse)}, the returned ServletRequest will be
     * the same as the one supplied to the above method. If the AsyncListener
     * was added via {@link AsyncContext#addListener(AsyncListener)}, this
     ...
     * If the AsyncListener to which this AsyncEvent is being delivered was
     * added using {@link AsyncContext#addListener(AsyncListener,
     * ServletRequest, ServletResponse)}, the returned ServletResponse will be
     * the same as the one supplied to the above method. If the AsyncListener
     * was added via {@link AsyncContext#addListener(AsyncListener)}, this
     * method must return null.
     *
     ...
     *
     * @return the Throwable that was used to initialize this AsyncEvent, or
     * null if this AsyncEvent was initialized without any Throwable
     */
