...
public interface RequestDispatcher {
     ...
     * made available to the target of a
    ...
    /**
     * The name of the request attribute under which the request URI of the
     * target of an {@link #include(ServletRequest,ServletResponse)
     * include} is stored
     */
    static final String INCLUDE_REQUEST_URI = "javax.servlet.include.request_uri";

    /**
     * The name of the request attribute under which the context path of the
     * target of an {@link #include(ServletRequest,ServletResponse)
     * include} is stored
     */
    ...
    /**
     * The name of the request attribute under which the path info of the target
     * of an {@link #include(ServletRequest,ServletResponse)
     * include} is stored
     */
    static final String INCLUDE_PATH_INFO = "javax.servlet.include.path_info";

    /**
     * The name of the request attribute under which the servlet path of the
     * target of an {@link #include(ServletRequest,ServletResponse)
     * include} is stored
     */
    ...
    /**
     * The name of the request attribute under which the query string of the
     * target of an {@link #include(ServletRequest,ServletResponse)
     * include} is stored
     */
    ...
    /**
     * The name of the request attribute under which the exception object is
     * propagated during an error dispatch
     */
    public static final String ERROR_EXCEPTION = "javax.servlet.error.exception";

    /**
     * The name of the request attribute under which the type of the exception
     * object is propagated during an error dispatch
     */
    public static final String ERROR_EXCEPTION_TYPE = "javax.servlet.error.exception_type";

    /**
     * The name of the request attribute under which the exception message is
     * propagated during an error dispatch
     */
    public static final String ERROR_MESSAGE = "javax.servlet.error.message";

    /**
     * The name of the request attribute under which the request URI whose
     * processing caused the error is propagated during an error dispatch
     */
    public static final String ERROR_REQUEST_URI = "javax.servlet.error.request_uri";

    /**
     * The name of the request attribute under which the name of the servlet in
     * which the error occurred is propagated during an error dispatch
     */
    public static final String ERROR_SERVLET_NAME = "javax.servlet.error.servlet_name";

    /**
     * The name of the request attribute under which the response status is
     * propagated during an error dispatch
     */
