...
public abstract class ServletInputStream extends InputStream {
     ...
     * returns false.
     *
     * @return <code>true</code> when all data for this particular request has
     * been read, otherwise returns <code>false</code>.
     *
     * @since Servlet 3.1
     */
     ...
     *
     * @param readListener the {@link ReadListener} that should be notified when
     * it's possible to read.
     *
     * @exception IllegalStateException if one of the following conditions is
     * true
     * <ul>
