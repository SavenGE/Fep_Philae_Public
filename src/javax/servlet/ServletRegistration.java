...
public interface ServletRegistration extends Registration {
     ...
     *
     * <p>
     * If this method is called multiple times, each successive call adds to the
     ...
     * not affect this <code>ServletRegistration</code>.
     *
     ...
     * <code>ServletRegistration</code>.
     *
     * @return the name of the runAs role, or null if the Servlet is configured
     * to run as its caller
     */
    ...
    interface Dynamic extends ServletRegistration, Registration.Dynamic {
         ...
         *
         * <p>
         * A <tt>loadOnStartup</tt> value of greater than or equal to zero
         ...
         * the Servlet during the initialization phase of the ServletContext,
         * that is, after it has invoked all of the ServletContextListener
         * objects configured for the ServletContext at their
         * {@link ServletContextListener#contextInitialized} method.
         *
         * <p>
         * If <tt>loadOnStartup</tt> is a negative integer, the container is
         * free to instantiate and initialize the Servlet lazily.
         *
         * <p>
        ...
        /**
         * Sets the {@link ServletSecurityElement} to be applied to the mappings
         * defined for this <code>ServletRegistration</code>.
         *
         * <p>
         ...
         * <code>security-constraint</code> that was established via the
         * portable deployment descriptor, then this method does not change the
         * <code>security-constraint</code> for that pattern, and the pattern
         * will be included in the return value.
         *
         * <p>
         * If a URL pattern of this ServletRegistration is an exact target of a
         * security constraint that was established via the
         ...
         * constraint for that pattern.
         *
         * <p>
         * If a URL pattern of this ServletRegistration is neither the exact
         * target of a security constraint that was established via the
         * {@link javax.servlet.annotation.ServletSecurity} annotation or a
         * previous call to this method, nor the exact target of a
         * <code>security-constraint</code> in the portable deployment
         * descriptor, then this method establishes the security constraint for
         * that pattern from the argument <code>ServletSecurityElement</code>.
         *
         * @param constraint the {@link ServletSecurityElement} to be applied to
         * the patterns mapped to this ServletRegistration
         *
         ...
         * established via the portable deployment descriptor. This method has
         * no effect on the patterns included in the returned set
         *
         * @throws IllegalArgumentException if <tt>constraint</tt> is null
         *
         * @throws IllegalStateException if the {@link ServletContext} from
         * which this <code>ServletRegistration</code> was obtained has already
         * been initialized
         */
        public Set<String> setServletSecurity(ServletSecurityElement constraint);

        /**
         * Sets the {@link MultipartConfigElement} to be applied to the mappings
         * defined for this <code>ServletRegistration</code>. If this method is
         * called multiple times, each successive call overrides the effects of
         * the former.
         *
