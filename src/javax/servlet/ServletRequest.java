...
public interface ServletRequest {
     ...
     *
     * @param env <code>String</code> containing the name of the character
     * encoding.
     *
     * @throws UnsupportedEncodingException if this ServletRequest is still in a
     * state where a character encoding may be set, but the specified encoding
     * is invalid
     */
     ...
     * <br> If the object passed in is null, the effect is the same as calling
     * {@link #removeAttribute}.
     * <br> It is warned that when the request is dispatched from the servlet
     * resides in a different web application by <code>RequestDispatcher</code>,
     * the object set by this method may not be correctly retrieved in the
     * caller servlet.
     *
     * @param name a <code>String</code> specifying the name of the attribute
     *
     ...
     * resource. If it is relative, it must be relative against the current
     * servlet.
     *
     ...
     * response wrappers that they added during their <i>inbound</i>
     ...
     *
     * @throws IllegalStateException if this request is within the scope of a
     * filter or servlet that does not support asynchronous operations (that is,
     * {@link #isAsyncSupported} returns false), or if this method is called
     * again without any asynchronous dispatch (resulting from one of the
     * {@link AsyncContext#dispatch} methods), is called outside the scope of
     * any such dispatch, or is called again within the scope of the same
     * dispatch, or if the response has already been closed
     *
     ...
     * as an indication that some of the request and/or response wrappers that
     * they added during their <i>inbound</i>
     ...
     * ServletRequestWrapper applied during the <i>inbound</i>
     ...
     * call to {@link AsyncContext#getRequest()}, does not contain said
     ...
     * remain
     * <i>locked in</i> on the returned AsyncContext.
     *
     ...
     * asynchronous mode, i.e., if neither {@link #startAsync} nor
