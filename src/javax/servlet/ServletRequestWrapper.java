...
public class ServletRequestWrapper implements ServletRequest {
     ...
     * dispatched.
     *
     * @return the servlet context to which the wrapped servlet request was last
     * dispatched
     *
     * @since Servlet 3.0
     */
     ...
     *
     * @throws IllegalStateException if the request is within the scope of a
    ...
    /**
     * The default behavior of this method is to invoke
     * {@link ServletRequest#startAsync(ServletRequest, ServletResponse)} on the
     * wrapped request object.
     *
     ...
     *
     * @return true if this ServletRequestWrapper wraps the given ServletRequest
     ...
     *
     * @return true if this ServletRequestWrapper wraps a ServletRequest of the
     * given class type, false otherwise
     *
