...
public interface ServletResponse {
     ...
     * not both, except when {@link #reset} has been called.
     *
     ...
     * this method sets the HTTP Content-Length header.
     *
     * @param len a long specifying the length of the content being returned to
     * the client; sets the Content-Length header
     *
     * @since Servlet 3.1
     */
     ...
     *
     * @exception IllegalStateException if this method is called after content
     * has been written
     *
     * @see #getBufferSize
     * @see #flushBuffer
     ...
     * {@link #getOutputStream} is also cleared. It is legal, for instance, to
     * call {@link #getWriter}, {@link #reset} and then
