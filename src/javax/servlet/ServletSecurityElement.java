...
public class ServletSecurityElement extends HttpConstraintElement {
    ...
    /**
     * Constructs an instance with a default Constraint element and with no HTTP
     * Method specific constraint elements.
     *
     * @param constraint the HttpConstraintElement to be applied to all HTTP
     * methods other than those represented in the
    ...
    /**
     * Constructs an instance with a default Constraint element and with a
     * collection of HTTP Method specific constraint elements.
     *
     * @param constraint the HttpConstraintElement to be applied to all HTTP
     * methods other than those represented in the
     * <tt>methodConstraints</tt>
    ...
    /**
     * Gets the (possibly empty) collection of HTTP Method specific constraint
     * elements.
     *
     * <p>
     * If permitted, any changes to the returned <code>Collection</code> must
     * not affect this <code>ServletSecurityElement</code>.
     *
     *
