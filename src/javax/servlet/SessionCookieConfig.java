...
public interface SessionCookieConfig {
    ...
    /**
     * Sets the name that will be assigned to any session tracking cookies
     * created on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
     * was acquired.
     *
     * <p>
     * NOTE: Changing the name of session tracking cookies may break other tiers
     * (for example, a load balancing frontend) that assume the cookie name to
     * be equal to the default <tt>JSESSIONID</tt>, and therefore should only be
     * done cautiously.
     *
     * @param name the cookie name to use
     *
     * @throws IllegalStateException if the <tt>ServletContext</tt>
     * from which this <tt>SessionCookieConfig</tt> was acquired has already
     * been initialized
     */
    ...
    /**
     * Sets the path that will be assigned to any session tracking cookies
     * created on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
     * was acquired.
     *
     ...
     * from which this <tt>SessionCookieConfig</tt> was acquired will be used.
     *
    ...
    /**
     * Sets the comment that will be assigned to any session tracking cookies
     * created on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
     * was acquired.
     *
     * <p>
     * As a side effect of this call, the session tracking cookies will be
     * marked with a <code>Version</code> attribute equal to <code>1</code>.
     *
    ...
    /**
     * Gets the comment that will be assigned to any session tracking cookies
     * created on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
     * was acquired.
     *
     ...
     * <tt>ServletContext</tt> from which this
     * <tt>SessionCookieConfig</tt> was acquired as
     * <i>HttpOnly</i>.
     *
     * <p>
     * A cookie is marked as <tt>HttpOnly</tt> by adding the
     * <tt>HttpOnly</tt> attribute to it. <i>HttpOnly</i> cookies are not
     * supposed to be exposed to client-side scripting code, and may therefore
     * help mitigate certain kinds of cross-site scripting attacks.
     *
     ...
     * application represented by the
     * <tt>ServletContext</tt> from which this
     * <tt>SessionCookieConfig</tt> was acquired will be marked as
     * <i>HttpOnly</i>.
     *
     ...
     * application represented by the
     * <tt>ServletContext</tt> from which this
     * <tt>SessionCookieConfig</tt> was acquired as <i>secure</i>.
     *
     * <p>
     * One use case for marking a session tracking cookie as
     * <tt>secure</tt>, even though the request that initiated the session came
     * over HTTP, is to support a topology where the web container is
     * front-ended by an SSL offloading load balancer. In this case, the traffic
     * between the client and the load balancer will be over HTTPS, whereas the
     ...
     * the application represented by the <tt>ServletContext</tt>
     * from which this <tt>SessionCookieConfig</tt> was acquired shall be marked
     * as <i>secure</i> even if the request that initiated the corresponding
    ...
    /**
     * Sets the lifetime (in seconds) for the session tracking cookies created
     * on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
     * was acquired.
     *
     * @param maxAge the lifetime (in seconds) of the session tracking cookies
     * created on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
     * was acquired.
     *
    ...
    /**
     * Gets the lifetime (in seconds) of the session tracking cookies created on
     ...
     *
     * @return the lifetime (in seconds) of the session tracking cookies created
     * on behalf of the application represented by the
     * <tt>ServletContext</tt> from which this <tt>SessionCookieConfig</tt>
