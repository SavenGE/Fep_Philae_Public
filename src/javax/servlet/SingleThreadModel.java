 ...
 * that no two threads will execute concurrently in the servlet's
 * <code>service</code> method. The servlet container can make this guarantee by
 * synchronizing access to a single instance of the servlet, or by maintaining a
