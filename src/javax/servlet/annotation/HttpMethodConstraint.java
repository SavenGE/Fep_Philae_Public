...
public @interface HttpMethodConstraint {
     ...
     *
     * @return the name of an HTTP protocol method. <code>value</code> may not
     * be null, or the empty string, and must be a legitimate HTTP Method name
     ...
     * elements, its meaning depends on the value returned by
     ...
     * independent of authentication state and identity. When the array contains
     * the names of one or more roles, it indicates that access is contingent on
     * membership in at least one of the named roles (independent of the value
