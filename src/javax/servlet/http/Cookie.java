...
public class Cookie implements Cloneable, Serializable {
     ...
     *
     * @param domain the domain name within which this cookie is visible; form
     ...
     * <i>/catalog</i>, which makes the cookie visible to all directories on the
     * server under
     * <i>/catalog</i>.
     *
     * <p>
     ...
     * the server only when using a secure protocol; if <code>false</code>, sent
     * on any protocol
     *
     * @see #getSecure
     */
