...
public abstract class HttpServlet extends GenericServlet {
     ...
     * network resources.
     *
     * @param req the <code>HttpServletRequest</code> object that is sent to the
     * servlet
     *
     * @return a   <code>long</code> integer specifying the time the
     * <code>HttpServletRequest</code> object was last modified, in milliseconds
     ...
     *
     * @param resp the response object that the servlet uses to return the
     * headers to the clien
     *
     * @exception IOException if an input or output error occurs
     *
     * @exception ServletException if the request for the HEAD could not be
     * handled
     */
     ...
     *
     * @param resp the {@link HttpServletResponse} object that contains the
     * response the servlet returns to the client
     *
     * @exception IOException if an input or output error occurs while the
     * servlet is handling the PUT request
     *
     ...
     *
     * @exception IOException if an input or output error occurs while the
     * servlet is handling the DELETE request
     *
     * @exception ServletException if the request for the DELETE cannot be
     * handled
     */
     ...
     *
     * @exception IOException if an input or output error occurs while the
     * servlet is handling the OPTIONS request
     *
     * @exception ServletException if the request for the OPTIONS cannot be
     * handled
     */
     ...
     *
     * @exception ServletException if the request for the TRACE cannot be
     * handled
     */
