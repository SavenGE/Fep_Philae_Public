...
public interface HttpServletRequest extends ServletRequest {
     ...
     * header expressed as the number of milliseconds since January 1, 1970 GMT,
     * or -1 if the named header was not included with the request
     *
     * @exception	IllegalArgumentException	If the header value can't be
     * converted to a date
     */
     ...
     *
     * @exception	NumberFormatException	If the header value can't be converted
     * to an <code>int</code>
     */
     ...
     * with role-name “**”, <code>isUserInRole</code> must only return true if
     * the user has been authenticated; that is, only when
     * {@link #getRemoteUser} and {@link #getUserPrincipal} would both return a
     * non-null value. Otherwise, the container must check the user for
     ...
     *
     * @throws IllegalStateException if there is no session associated with the
     * request
     *
     * @since Servlet 3.1
     */
     ...
     *
     * @param response The <code>HttpServletResponse</code> associated with this
     ...
     *
     * @throws IOException if an input or output error occurred while reading
     * from this request or writing to the given response
     *
     * @throws IllegalStateException if the login mechanism attempted to modify
     * the response and it was already committed
     *
     * @throws ServletException if the authentication failed and the caller is
     * responsible for handling the error (i.e., the underlying login mechanism
     * did NOT establish the message and HTTP status code to be returned to the
     * user)
     *
     * @since Servlet 3.0
     */
     ...
     *
     * @param username The <code>String</code> value corresponding to the login
     * identifier of the user.
     *
     * @param password The password <code>String</code> corresponding to the
     * identified user.
     *
     * @exception	ServletException if the configured login mechanism does not
     * support username password authentication, or if a non-null caller
     * identity had already been established (prior to the call to login), or if
     ...
     * of type <code>multipart/form-data</code>.
     *
     * <p>
     * If this request is of type <code>multipart/form-data</code>, but does not
     * contain any <code>Part</code> components, the returned
     ...
     * <code>maxRequestSize</code>, or any <code>Part</code> in the request is
     * larger than <code>maxFileSize</code>, or there is no
     ...
     *
     * @return The <code>Part</code> with the given name, or <code>null</code>
     * if this request is of type <code>multipart/form-data</code>, but does not
     * contain the requested <code>Part</code>
     *
     * @throws IOException if an I/O error occurred during the retrieval of the
     * requested <code>Part</code>
     * @throws ServletException if this request is not of type
     * <code>multipart/form-data</code>
     * @throws IllegalStateException if the request body is larger than
     * <code>maxRequestSize</code>, or any <code>Part</code> in the request is
    ...
    /**
     * Create an instance of <code>HttpUpgradeHandler</code> for an given class
     * and uses it for the http protocol upgrade processing.
     *
     * @param handlerClass The <code>HttpUpgradeHandler</code> class used for
     * the upgrade.
     *
     * @return an instance of the <code>HttpUpgradeHandler</code>
     *
     * @exception IOException if an I/O error occurred during the upgrade
     * @exception ServletException if the given <code>handlerClass</code> fails
     * to be instantiated
     *
