...
public interface HttpServletResponse extends ServletResponse {
    ...
    /**
     * Encodes the specified URL by including the session ID, or, if encoding is
     ...
     * encoded in the URL. For example, if the browser supports cookies, or
     ...
     * unnecessary. Because the rules for making this determination can differ
     * from those used to decide whether to encode a normal link, this method is
     * separated from the <code>encodeURL</code> method.
     *
     * <p>
     ...
     * clears the buffer.
     *
     * The server will preserve cookies and may clear or update any headers
     * needed to serve the error page as a valid response.
     *
     * If an error-page declaration has been made for the web application
     ...
     * @param	sc	the error status code
     * @exception	IOException	If an input or output exception occurs
     * @exception	IllegalStateException	If the response was committed before
     * this method call
     */
     ...
     * code to {@link #SC_FOUND} 302 (Found). This method can accept relative
     ...
     * the container interprets it as relative to the servlet container root. If
     * the location is relative with two leading '/' the container interprets it
     * as a network-path reference (see
     * <a href="http://www.ietf.org/rfc/rfc3986.txt">
     * RFC 3986: Uniform Resource Identifier (URI): Generic Syntax</a>, section
     ...
     *
     * <p>
     * If this method is used to set an error code, then the container's error
     * page mechanism will not be triggered. If there is an error and the caller
     * wishes to invoke an error page defined in the web application, then
     ...
     * parameter. To set a status code use <code>setStatus(int)</code>, to send
     * an error with a description use <code>sendError(int, String)</code>.
     *
     ...
     *
     * <p>
     * This method considers only response headers set or added via null null
     * null null null null null null null null null null null null null null     {@link #setHeader}, {@link #addHeader}, {@link #setDateHeader},
     * {@link #addDateHeader}, {@link #setIntHeader}, or {@link #addIntHeader},
     * respectively.
     *
