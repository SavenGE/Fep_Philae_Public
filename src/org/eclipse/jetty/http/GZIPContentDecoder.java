 ...
 * <p>
 * A decoder that inflates gzip compressed data that has been optimized for
 * async usage with minimal data copies.
 */
public class GZIPContentDecoder implements Destroyable {
     ...
     * returned from {@link #decode(ByteBuffer)}. Derived implementations may
     * choose to consume chunks individually and return false to prevent further
     * inflation until a subsequent call to {@link #decode(ByteBuffer)} or
     * {@link #decodeChunks(ByteBuffer)}.
     *
     * @param chunk The inflated chunk of data
     * @return False if inflating should continue, or True if the call to
     * {@link #decodeChunks(ByteBuffer)} or {@link #decode(ByteBuffer)} should
     * return, allowing back pressure of compressed data.
     */
     ...
     * <p>
     * Inflation continues until the compressed block end is reached, there is
     * no more compressed data or a call to {@link #decodedChunk(ByteBuffer)}
     * returns true.
     *
     ...
     * @return An indirect buffer of the configured buffersize either from the
     ...
     * <p>
     * This method will called {@link ByteBufferPool#release(ByteBuffer)} if a
     * buffer pool has been configured. This method should be called once for
     * all buffers returned from {@link #decode(ByteBuffer)} or passed to
     * {@link #decodedChunk(ByteBuffer)}.
     *
