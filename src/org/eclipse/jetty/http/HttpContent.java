...
public interface HttpContent {
    ...
    public interface ContentFactory {
         ...
         * For cached content, a larger buffer may have previously been
         * allocated and returned by the {@link HttpContent#getDirectBuffer()}
         * or {@link HttpContent#getIndirectBuffer()} calls.
