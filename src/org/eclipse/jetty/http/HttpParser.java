 ...
 * <dt>LEGACY</dt><dd>(aka STRICT) Adherence to Servlet Specification
 * requirement for exact case of header names, bypassing the header caches,
 * which are case insensitive, otherwise equivalent to RFC2616</dd>
 * </dl>
 *
...
public class HttpParser {
 ...
 /* Event Handler interface
    ...
    public interface HttpHandler {
        ...
        /**
         * This is the method called by parser when a HTTP Trailer name and
         * value is found
         *
         * @param field The field parsed
         */
 ...
 /* ------------------------------------------------------------------------------- */
    public interface RequestHandler extends HttpHandler {
         ...
         * @param uri The raw bytes of the URI. These are copied into a
         * ByteBuffer that will not be changed until this parser is reset and
         * reused.
