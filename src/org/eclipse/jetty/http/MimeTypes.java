...
public class MimeTypes {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Get the MIME type by filename extension. Lookup only the static default
     * mime map.
     *
    ...
    /**
     * Access a mutable map of mime type to the charset inferred from that
     * content type. An inferred encoding is used by when encoding/decoding a
     * stream and is explicitly set in any metadata (eg Content-Type).
     *
     ...
     * type. An assumed encoding is used by when encoding/decoding a stream, but
     * is not explicitly set in any metadata (eg Content-Type).
     *
     * @return Map of mime type to charset
     */
