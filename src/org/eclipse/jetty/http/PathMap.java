 ...
 * <p>
 * This mapping implements the path specification recommended in the 2.2 Servlet
 * API.
 * </p>
 *
 * <p>
 ...
 * separators, unless configured differently by calling the static method @see
 ...
 * <p>
 * This class is not synchronized. If concurrent modifications are possible then
 * it should be synchronized at a higher level.
 *
 * @param <O> the Map.Entry value type
 * @deprecated replaced with {@link org.eclipse.jetty.http.pathmap.PathMappings}
...
public class PathMap<O> extends HashMap<String, O> {
     ...
     * string. By default this class uses ":," characters as path separators.
     *
     * @param s separators
     */
     ...
     *
     * @param dictMap the map representing the dictionary to build this PathMap
     * from
     */
     ...
     *
     * @param pathSpec The path specification, or comma separated list of path
     * specifications.
    ...
    /* --------------------------------------------------------------- */
    /**
     * Return whether the path matches any entries in the PathMap, excluding the
     * default entry
     *
     * @param path Path to match
     ...
     * @param pathSpec the path spec
     * @param path the path
     * @param noDefault true to not handle the default path "/" special, false
     * to allow matcher rules to run
     * @return true if match.
     */
