...
public enum PathSpecGroup {
     ...
     * </pre>
     *
     * Note: there is no known uri-template spec variant of this kind of path
     * spec
     */
    ROOT,
    /**
    ...
    EXACT,
    /**
     * For path specs that have a hardcoded prefix and suffix with wildcard glob
     * in the middle.
     *
     * <pre>
     ...
     * </pre>
     *
     * Per Servlet Spec, pathInfo is always null for these specs. If nothing
     * above matches, then default will match.
     */
    DEFAULT,
}
