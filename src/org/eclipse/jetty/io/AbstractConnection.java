...
/**
 * <p>
 * A convenience base implementation of {@link Connection}.</p>
 * <p>
 ...
 * will schedule a callback to {@link #onFillable()} or
 * {@link #onFillInterestedFailed(Throwable)} as appropriate.</p>
 */
public abstract class AbstractConnection implements Connection {
    ...
    /**
     * <p>
     * Utility method to be called to register read interest.</p>
     * <p>
     * After a call to this method, {@link #onFillable()} or
     * {@link #onFillInterestedFailed(Throwable)} will be called back as
     * appropriate.</p>
     *
     * @see #onFillable()
     */
    ...
    /**
     * <p>
     * Callback method invoked when the endpoint is ready to be read.</p>
     *
     * @see #fillInterested()
     */
    ...
    /**
     * <p>
     * Callback method invoked when the endpoint failed to be ready to be
     * read.</p>
     *
     ...
     * @return true to signal that the endpoint must be closed, false to keep
     * the endpoint open
     */
