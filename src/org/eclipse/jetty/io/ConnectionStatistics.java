...
/**
 * <p>
 * A {@link Connection.Listener} that tracks connection statistics.</p>
 * <p>
 * Adding an instance of this class as a bean to a server Connector (for the
 * server) or to HttpClient (for the client) will trigger the tracking of the
 * connection statistics for all connections managed by the server Connector or
 * by HttpClient.</p>
 */
