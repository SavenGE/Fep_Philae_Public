...
public abstract class FillInterest {
    ...
    /**
     * Call to register interest in a callback when a read is possible. The
     * callback will be called either immediately if
     * {@link #needsFillInterest()} returns true or eventually once
     * {@link #fillable()} is called.
     *
    ...
    /**
     * Register the read interest Abstract method to be implemented by the
     * Specific ReadInterest to schedule a future call to {@link #fillable()} or
