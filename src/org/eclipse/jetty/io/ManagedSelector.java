...
/**
 * <p>
 * {@link ManagedSelector} wraps a {@link Selector} simplifying non-blocking
 * operations on channels.</p>
 * <p>
 * {@link ManagedSelector} runs the select loop, which waits on
 * {@link Selector#select()} until events happen for registered channels. When
 * events happen, it notifies the {@link EndPoint} associated with the
 * channel.</p>
 */
public class ManagedSelector extends ContainerLifeCycle implements Dumpable {
    ...
    /**
     * Submit an {@link SelectorUpdate} to be acted on between calls to
    ...
    /**
     * A {@link Selectable} is an {@link EndPoint} that wish to be notified of
     * non-blocking events by the {@link ManagedSelector}.
     */
    public interface Selectable {

        /**
         * Callback method invoked when a read or write events has been detected
         * by the {@link ManagedSelector} for this endpoint.
         *
