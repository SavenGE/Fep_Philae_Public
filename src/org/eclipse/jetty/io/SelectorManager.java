 ...
 * simplify the non-blocking primitives provided by the JVM via the
 * {@code java.nio} package.</p>
 * <p>
 * {@link SelectorManager} subclasses implement methods to return
 * protocol-specific {@link EndPoint}s and {@link Connection}s.</p>
 */
...
public abstract class SelectorManager extends ContainerLifeCycle implements Dumpable {
    ...
    /**
     * @param executor The executor to use for handling selected
     * {@link EndPoint}s
     * @param scheduler The scheduler to use for timing events
     * @param selectors The number of selectors to use, or -1 for a default
    ...
    /**
     * <p>
     * Registers a channel to perform a non-blocking connect.</p>
     * <p>
     * The channel must be set in non-blocking mode,
     * {@link SocketChannel#connect(SocketAddress)} must be called prior to
     * calling this method, and the connect operation must not be completed (the
     * return value of {@link SocketChannel#connect(SocketAddress)} must be
     * false).</p>
     *
    ...
    /**
     * <p>
     * Registers a channel to perform non-blocking read/write operations.</p>
     * <p>
     * This method is called just after a channel has been accepted by
     * {@link ServerSocketChannel#accept()}, or just after having performed a
     * blocking connect via {@link Socket#connect(SocketAddress, int)}, or just
     * after a non-blocking connect via
     * {@link SocketChannel#connect(SocketAddress)} that completed
     * successfully.</p>
     *
     * @param channel the channel to register
     * @param attachment the attachment object
     ...
     * {@link SocketChannel} is accepted from the given
     * {@link ServerSocketChannel} then the {@link #accepted(SelectableChannel)}
     * method is called, which must be overridden by a derivation of this class
     * to handle the accepted channel
     *
     ...
     * {@link ServerSocketChannel} passed to
     * {@link #acceptor(SelectableChannel)}. The default impl throws an
     * {@link UnsupportedOperationException}, so it must be overridden by
     * subclasses if a server channel is provided.
     *
     * @param channel the
    ...
    /**
     * <p>
     * Factory method for {@link ManagedSelector}.</p>
     *
    ...
    /**
     * <p>
     * Callback method invoked when an endpoint is opened.</p>
     *
    ...
    /**
     * <p>
     * Callback method invoked when an endpoint is closed.</p>
     *
    ...
    /**
     * <p>
     * Callback method invoked when a connection is opened.</p>
     *
    ...
    /**
     * <p>
     * Callback method invoked when a connection is closed.</p>
     *
    ...
    /**
     * <p>
     * Callback method invoked when a non-blocking connect cannot be
     * completed.</p>
     * <p>
     * By default it just logs with level warning.</p>
     *
    ...
    /**
     * <p>
     * Factory method to create {@link EndPoint}.</p>
     * <p>
     * This method is invoked as a result of the registration of a channel via
     * {@link #connect(SelectableChannel, Object)} or
     * {@link #accept(SelectableChannel)}.</p>
     *
    ...
    /**
     * <p>
     * Factory method to create {@link Connection}.</p>
     *
