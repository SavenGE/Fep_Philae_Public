...
/**
 * <p>
 * LifeCycle wrapper for JMXConnectorServer.</p>
 * <p>
 * This class provides the following facilities:</p>
 * <ul>
 * <li>participates in the {@code Server} lifecycle</li>
 * <li>starts the RMI registry if not there already</li>
 * <li>allows to bind the RMI registry and the RMI server to the loopback
 * interface</li>
...
public class ConnectorServer extends AbstractLifeCycle {
     ...
     * ConnectorServer's behavior. This parameter can be null. Keys in this map
     * must be Strings. The appropriate type of each associated value depends on
