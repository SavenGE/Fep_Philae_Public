...
/**
 * <p>
 * A dynamic MBean that can wrap an arbitrary Object instance.</p>
 * <p>
 * The attributes and operations exposed by this bean are controlled by the
 * merge of annotations discovered in all superclasses and all
 * superinterfaces.</p>
 * <p>
 * Given class {@code com.acme.Foo}, then {@code com.acme.jmx.FooMBean} is
 * searched; if found, it is instantiated with the {@code com.acme.Foo} instance
 * passed to the constructor.</p>
 * <p>
 * Class {@code com.acme.jmx.FooMBean} can then override the default behavior of
 * ObjectMBean and provide a custom ObjectName, or custom ObjectName properties
 * {@code name} and {@code context}, etc.</p>
 */
public class ObjectMBean implements DynamicMBean {

    private static final Logger LOG = Log.getLogger(ObjectMBean.class);
    private static final Class<?>[] OBJ_ARG = new Class[]{
        Object.class
    };
    ...
    /**
     * <p>
     * Creates an ObjectMBean for the given object.</p>
     * <p>
     ...
     * </pre>
     * <p>
     * then this method would look for the following classes:</p>
     * <ul>
    ...
    /**
     * <p>
     * Allows to customize the ObjectName of this MBean.</p>
     *
     * @return a custom ObjectName, or null to indicate to
     * {@link MBeanContainer} to create a default ObjectName
     */
    ...
    /**
     * <p>
     * Allows to customize the ObjectName property {@code context}.</p>
     * <p>
     * When {@link MBeanContainer} creates default ObjectNames, the
     * {@code context} property is "inherited" recursively by MBeans that are
     * children of this MBean; this allows to "group" descendant MBeans so that
     * it is clear who is the ancestor they belong to.</p>
     * <p>
     * For example, if object A has a child component B which has children
     * components C, then AMBean can override this method to return "alpha", and
     * then the ObjectNames will be:</p>
     * <ul>
    ...
    /**
     * <p>
     * Allows to customize the ObjectName property {@code name}.</p>
     * <p>
     * Certain components have a natural name and returning it from this method
    ...
    /**
     * <p>
     * Defines an attribute for the managed object using the annotation
     * attributes.</p>
     *
    ...
    /**
     * <p>
     * Defines an operation for the managed object using the annotation
     * attributes.</p>
     *
