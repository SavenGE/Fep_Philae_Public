...
public class ConstraintSecurityHandler extends SecurityHandler implements ConstraintAware {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Generate Constraints and ContraintMappings for the given url pattern and
     ...
     *
     * @param constraintMappings The constraintMappings to set, from which the
     * set of known roles is determined.
     */
     ...
     * spec section 13.7.1 Note that much of the logic is in the RoleInfo class.
     *
     * @param constraintMappings The constraintMappings to set as array, from
     * which the set of known roles is determined. Needed to retain API
     * compatibility for 7.x
     */
     ...
     * @param roles The known roles (or null to determine them from the
     * mappings)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the known roles. This may be overridden by a subsequent call to
     * {@link #setConstraintMappings(ConstraintMapping[])} or
    ...
    /**
     * @see
     * org.eclipse.jetty.security.ConstraintAware#addConstraintMapping(org.eclipse.jetty.security.ConstraintMapping)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * Constraints that name method omissions are dealt with differently. We
     * create an entry in the mappings with key "&lt;method&gt;.omission". This
     * entry is only ever combined with other omissions for the same method to
     * produce a consolidated RoleInfo. Then, when we wish to find the relevant
     * constraints for a given Request (in prepareConstraintInfo()), we consult
     * 3 types of entries in the mappings: an entry that names the method of the
     * Request specifically, an entry that names constraints that apply to all
     * methods, entries of the form &lt;method&gt;.omission, where the method of
     * the Request is not named in the omission.
     *
     * @param mapping the constraint mapping
    ...
    /* ------------------------------------------------------------ */
    /**
     * Find constraints that apply to the given path. In order to do this, we
     * consult 3 different types of information stored in the mappings for each
     * path - each mapping represents a merged set of user data constraints,
     * roles etc -:
     * <ol>
     * <li>A mapping of an exact method name </li>
     * <li>A mapping with key * that matches every method name</li>
     * <li>Mappings with keys of the form
     * "&lt;method&gt;.&lt;method&gt;.&lt;method&gt;.omission" that indicates it
     * will match every method name EXCEPT those given</li>
     * </ol>
     *
     * @see
     * org.eclipse.jetty.security.SecurityHandler#prepareConstraintInfo(java.lang.String,
    ...
    /**
     * @see
     * org.eclipse.jetty.security.SecurityHandler#checkWebResourcePermissions(java.lang.String,
     * org.eclipse.jetty.server.Request, org.eclipse.jetty.server.Response,
     * java.lang.Object, org.eclipse.jetty.server.UserIdentity)
     */
    @Override
    ...
    /**
     * @see
     * org.eclipse.jetty.security.ConstraintAware#setDenyUncoveredHttpMethods(boolean)
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * Servlet spec 3.1 pg. 147. The container must check all the combined
     * security constraint information and log any methods that are not
     * protected and the urls at which they are not protected
     *
    ...
    public Set<String> getPathsWithUncoveredHttpMethods() {
        ...
        for (String path : _constraintMap.keySet()) {
            ...
            for (String method : methodMappings.keySet()) {
                ...
                } else //an exact method name
                if (!hasOmissions) //a http-method does not have http-method-omission to cover the other method names
                {
                    uncoveredPaths.add(path);
                }
    ...
    /* ------------------------------------------------------------ */
    /**
     * Check if any http method omissions exist in the list of method to auth
     * info mappings.
     *
     * @param path the path
     ...
     * <code>&lt;method&gt;.&lt;method&gt;.omission</code> split out the
