...
/* ------------------------------------------------------------ */
/**
 * Default Identity Service implementation. This service handles only role
 * reference maps passed in an associated
 * {@link org.eclipse.jetty.server.UserIdentity.Scope}. If there are roles refs
 * present, then associate will wrap the UserIdentity with one that uses the
 * role references in the
