...
public interface IdentityService {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Associate a user identity with the current thread. This is called with as
     * a thread enters the
    ...
    /* ------------------------------------------------------------ */
    /**
     * Disassociate the user identity from the current thread and restore
     * previous identity.
     *
     * @param previous The opaque object returned from a call to
     * {@link IdentityService#associate(UserIdentity)}
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Disassociate the current runAsToken from the thread and reassociate the
     * previous token.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Create a new UserIdentity for use with this identity service. The
     * UserIdentity should be immutable and able to be cached.
     *
     * @param subject Subject to include in UserIdentity
     * @param userPrincipal Principal to include in UserIdentity. This will be
     * returned from getUserPrincipal calls
