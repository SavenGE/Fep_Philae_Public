 ...
 * to check credentials and to create a {@link UserIdentity} using the set
...
public interface LoginService {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Validate a user identity. Validate that a UserIdentity previously created
     * by a call to {@link #login(String, Object, ServletRequest)} is still
     * valid.
     *
