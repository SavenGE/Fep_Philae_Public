 ...
 * <p>
 * The Authenticator may either be directly set on the handler or will be create
 * during {@link #start()} with a call to either the default or set
 * AuthenticatorFactory.
 * <p>
 * SecurityHandler has a set of initparameters that are used by the
 * Authentication.Configuration. At startup, any context init parameters that
 * start with "org.eclipse.jetty.security." that do not have values in the
 * SecurityHandler init parameters, are copied.
 */
public abstract class SecurityHandler extends HandlerWrapper implements Authenticator.AuthConfiguration {
    ...
    /**
     * @see
     * org.eclipse.jetty.security.Authenticator.AuthConfiguration#isSessionRenewedOnAuthentication()
     */
    @Override
     ...
     * <p>
     * If set to true, then on authentication, the session associated with a
     * reqeuest is invalidated and replaced with a new session.
     *
