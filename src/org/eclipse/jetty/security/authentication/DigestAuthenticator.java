 ...
 * {@link SecurityHandler#setInitParameter(String, String)} using the name
 * "maxNonceAge". The nonce max count can be set with
 * {@link SecurityHandler#setInitParameter(String, String)} using the name
 * "maxNonceCount". When the age or count is exceeded, the nonce is considered
 * stale.
 */
