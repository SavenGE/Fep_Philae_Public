 ...
 *
 * <p>
 * This authenticator implements form authentication will use dispatchers to the
 * login page if the {@link #__FORM_DISPATCH} init parameter is set to true.
 * Otherwise it will redirect.</p>
 *
 * <p>
 * The form authenticator redirects unauthenticated requests to a log page which
 * should use a form to gather username/password from the user and send them to
 * the /j_security_check URI within the context. FormAuthentication uses
 * {@link SessionAuthentication} to wrap Authentication results so that they are
...
public class FormAuthenticator extends LoginAuthenticator {
    ...
    /* ------------------------------------------------------------ */
    /**
     * If true, uris that cause a redirect to a login page will always be
     * remembered. If false, only the first uri that leads to a login page
     * redirect is remembered. See
     * https://bugs.eclipse.org/bugs/show_bug.cgi?id=379909
     *
    ...
    /**
     * @see
     * org.eclipse.jetty.security.authentication.LoginAuthenticator#setConfiguration(org.eclipse.jetty.security.Authenticator.AuthConfiguration)
     */
    @Override
