...
public class SpnegoAuthenticator extends LoginAuthenticator {
    ...
    /**
     * Allow for a custom authMethod value to be set for instances where SPENGO
     ...
     * {@code Authorization: <auth_scheme> <token>}.
     *
    ...
    /**
     * Determines if provided auth scheme text from the Authorization header is
     * case-insensitively equal to {@code negotiate}.
     *
     * @param authScheme The auth scheme component of the Authorization header
     * @return True if the auth scheme component is case-insensitively equal to
     * {@code negotiate}, False otherwise.
     */
