 ...
 * Connection.Listener instances found as beans on the {@link Connector} and
 * this {@link ConnectionFactory}</li>
 * </ul>
 * </ul>
 */
@ManagedObject
public abstract class AbstractConnectionFactory extends ContainerLifeCycle implements ConnectionFactory {
    ...
    protected AbstractConnectionFactory(String protocol) {
        _protocol = protocol;
        _protocols = Collections.unmodifiableList(Arrays.asList(new String[]{
            protocol
        }));
    }
