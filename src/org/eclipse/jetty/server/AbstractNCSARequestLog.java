...
/**
 * Base implementation of the {@link RequestLog} outputs logs in the
 * pseudo-standard NCSA common log format. Configuration options allow a choice
 * between the standard Common Log Format (as used in the 3 log format) and the
 * Combined Log Format (single log format). This log format can be output by
 * most web servers, and almost all web log analysis software can understand
 * these formats.
 */
public abstract class AbstractNCSARequestLog extends AbstractLifeCycle implements RequestLog {
     ...
     *
     * @param preferProxiedForAddress true - IP address from header will be
     * logged, false - IP address from the connection will be logged
     */
     ...
     *
     * @param extended true - log the extended request information, false - do
     * not log the extended request information
     */
    ...
    /**
     * Set the timestamp format for request log entries in the file. If this is
     * not set, the pre-formated request timestamp is used.
     *
