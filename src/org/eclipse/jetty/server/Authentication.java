 ...
 * <p>
 * The Authentication state can be one of several sub-types that reflects where
 * the request is in the many different authentication cycles. Authentication
 * might not yet be checked or it might be checked and failed, checked and
 * deferred or succeeded.
 */
public interface Authentication {
    ...
    /* ------------------------------------------------------------ */
    /**
     * A wrapped authentication with methods provide the wrapped
     * request/response for use by the application
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * A deferred authentication with methods to progress the authentication
     * process.
     */
    public interface Deferred extends Authentication {
        ...
        /* ------------------------------------------------------------ */
        /**
         * Authenticate if possible without sending a challenge. This is used to
         * check credentials that have been sent for non-manditory
         * authentication.
         *
        ...
        /* ------------------------------------------------------------ */
        /**
         * Authenticate and possibly send a challenge. This is used to initiate
         * authentication for previously non-manditory authentication.
         *
         * @param request the request
    ...
    /* ------------------------------------------------------------ */
    /**
     * Authentication Response sent state. Responses are sent by authenticators
     * either to issue an authentication challenge or on successful
     * authentication in order to redirect the user to the original URL.
     */
     ...
     * <p>
     * This convenience instance is for non mandatory authentication where
     * credentials have been presented and checked, but failed authentication.
     */
     ...
     * <p>
     * This convenience instance is for when an authentication challenge has
     * been sent.
     */
     ...
     * <p>
     * This convenience instance is for when an authentication failure has been
     * sent.
     */
