...
public class CachedContentFactory implements HttpContent.ContentFactory {
    ...
    /**
     * <p>
     * Returns an entry from the cache, or creates a new one.</p>
     *
     * @param pathInContext The key into the cache
     * @param maxBufferSize The maximum buffer size allocated for this request.
     * For cached content, a larger buffer may have previously been allocated
     * and returned by the {@link HttpContent#getDirectBuffer()} or
     * {@link HttpContent#getIndirectBuffer()} calls.
     * @return The entry matching {@code pathInContext}, or a new entry if no
     * matching entry was found. If the content exists but is not cacheable,
     * then a {@link ResourceHttpContent} instance is returned. If the resource
     ...
     * @return whether the resource is cacheable. The default implementation
     * tests the cache sizes.
     */
