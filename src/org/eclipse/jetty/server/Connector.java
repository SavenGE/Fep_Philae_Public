...
/**
 * <p>
 * A {@link Connector} accept connections and data from remote peers, and allows
 * applications to send data to remote peers, by setting up the machinery needed
 * to handle such tasks.</p>
 */
@ManagedObject("Connector Interface")
public interface Connector extends LifeCycle, Container, Graceful {

    /**
     * @return the {@link Server} instance associated with this
     * {@link Connector}
     */
    ...
    /**
     * @return the {@link ByteBufferPool} to acquire buffers from and release
     * buffers to
     */
    ...
    /**
     * @return the default {@link ConnectionFactory} associated with the default
     * protocol name
     */
     ...
     * <p>
     * A {@link ContextHandler} may be configured with virtual hosts in the form
     * "@connectorName" and will only serve requests from the named connector.
     *
