 ...
 * {@link AbstractConnector#addBean(Object)} will register the listener with all
 * connections accepted by that connector.
 *
...
public class ConnectorStatistics extends AbstractLifeCycle implements Dumpable, Connection.Listener {
    ...
    public void dump(Appendable out, String indent) throws IOException {
        ...
        ContainerLifeCycle.dump(out, indent, Arrays.asList(new String[]{
            "connections=" + _connectionStats, "duration=" + _connectionDurationStats, "in=" + _messagesIn, "out=" + _messagesOut
        }));
    }
