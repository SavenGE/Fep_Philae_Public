 ...
 * <p>
 * This customizer looks at at HTTP request for headers that indicate it has
 * been forwarded by one or more proxies. Specifically handled are
 * <ul>
 * <li>{@code Forwarded}, as defined by
 * <a href="https://tools.ietf.org/html/rfc7239">rfc7239</a>
 ...
 * </ul>
 * <p>
 * If these headers are present, then the {@link Request} object is updated so
 * that the proxy is not seen as the other end point of the connection on which
 * the request came</p>
 * <p>
...
public class ForwardedRequestCustomizer implements Customizer {
    ...
    /**
     * @return true if the proxy address obtained via {@code X-Forwarded-Server}
    ...
    /**
     * @param rfc7239only Configure to only support the RFC7239 Forwarded header
     * and to not support any {@code X-Forwarded-} headers. This convenience
     * method clears all the non RFC headers if passed true and sets them to the
     * default values (if not already set) if passed false.
     */
    ...
    /**
     * @param forwardedHeader The header name for RFC forwarded (default
     * Forwarded)
     */
    ...
    /**
     * @param forwardedHostHeader The header name for forwarded hosts (default
    ...
    /**
     * @param forwardedServerHeader The header name for forwarded server
     * (default {@code X-Forwarded-Server})
     */
    ...
    /**
     * @param forwardedRemoteAddressHeader The header name for forwarded for
     * (default {@code X-Forwarded-For})
     */
     ...
     *
     * @param forwardedProtoHeader the forwardedProtoHeader to set (default
    ...
    /**
     * @return The header name holding a forwarded cipher suite (default
     * {@code Proxy-auth-cert})
     */
    ...
    /**
     * @param forwardedCipherSuite The header name holding a forwarded cipher
     * suite (default {@code Proxy-auth-cert})
     */
    ...
    /**
     * @return The header name holding a forwarded SSL Session ID (default
     * {@code Proxy-ssl-id})
     */
    ...
    /**
     * @param forwardedSslSessionId The header name holding a forwarded SSL
     * Session ID (default {@code Proxy-ssl-id})
     */
    ...
    /**
     * @return The header name holding a forwarded Https status indicator
     * (on|off true|false) (default {@code X-Proxied-Https})
     */
    ...
    /**
     * @param forwardedHttpsHeader the header name holding a forwarded Https
     * status indicator(default {@code X-Proxied-Https})
     */
    ...
    /**
     * @return true if the presence of a SSL session or certificate header is
     * sufficient to indicate a secure request (default is true)
     */
    ...
    /**
     * @param sslIsSecure true if the presence of a SSL session or certificate
     * header is sufficient to indicate a secure request (default is true)
     */
