...
public class HttpChannelOverHttp extends HttpChannel implements HttpParser.RequestHandler, HttpParser.ComplianceHandler {
    ...
    /**
     * <p>
     * Attempts to perform a HTTP/1.1 upgrade.</p>
     * <p>
     * The upgrade looks up a {@link ConnectionFactory.Upgrading} from the
     * connector matching the protocol specified in the {@code Upgrade}
     * header.</p>
     * <p>
     * The upgrade may succeed, be ignored (which can allow a later handler to
     * implement) or fail with a {@link BadMessageException}.</p>
     *
