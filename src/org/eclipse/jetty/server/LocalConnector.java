...
public class LocalConnector extends AbstractConnector {
    ...
    /**
     * Sends requests and get responses based on thread activity. Returns all
     * the responses received once the thread activity has returned to the level
     * it was before the requests.
     * <p>
     * This methods waits until the connection is closed or is idle for 5s
     * before returning the responses.
     * <p>
     * Use {@link #getResponse(String)} for an alternative that does not wait
     * for idle.
     *
     ...
     * it was before the requests.
     * <p>
     * This methods waits until the connection is closed or an idle period
     * before returning the responses.
     * <p>
     * Use {@link #getResponse(String)} for an alternative that does not wait
     * for idle.
     *
     * @param requests the requests
     * @param idleFor The time the response stream must be idle for before
     * returning
    ...
    /**
     * Sends requests and get's responses based on thread activity. Returns all
     * the responses received once the thread activity has returned to the level
     * it was before the requests.
     * <p>
     * This methods waits until the connection is closed or is idle for 5s
     * before returning the responses.
     * <p>
     * Use {@link #getResponse(ByteBuffer)} for an alternative that does not
     * wait for idle.
     *
    ...
    /**
     * Execute a request and return the EndPoint through which multiple
     * responses can be received or more input provided.
     *
    ...
    /**
     * Get a single response using a parser to search for the end of the
     * message.
     *
    ...
    public class LocalEndPoint extends ByteArrayEndPoint {
         ...
         * {@link #waitForResponse(boolean, long, TimeUnit)}
         *
