...
/**
 * <p>
 * A specialized version of {@link ServerConnector} that supports
 * {@link NetworkTrafficListener}s.</p>
 * <p>
 * {@link NetworkTrafficListener}s can be added and removed dynamically before
 * and after this connector has been started without causing
 * {@link java.util.ConcurrentModificationException}s.</p>
 */
