...
/**
 * <p>
 * ConnectionFactory for the PROXY Protocol.</p>
 * <p>
 * This factory can be placed in front of any other connection factory to
 * process the proxy v1 or v2 line before the normal protocol handling</p>
 *
 * @see
 * <a href="http://www.haproxy.org/download/1.5/doc/proxy-protocol.txt">http://www.haproxy.org/download/1.5/doc/proxy-protocol.txt</a>
 */
public class ProxyConnectionFactory extends AbstractConnectionFactory {
    ...
    /**
     * Proxy Connection Factory that uses the next ConnectionFactory on the
     * connector as the next protocol
     */
