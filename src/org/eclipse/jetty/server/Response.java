...
/**
 * <p>
 * {@link Response} provides the implementation for
...
public class Response implements HttpServletResponse {
    ...
    /**
     * If a header name starts with this string, the header (stripped of the
     * prefix) can be set during include using only
     * {@link #setHeader(String, String)} or {@link #addHeader(String, String)}.
     */
     ...
     * {@link #addCookie(Cookie)}, then the cookie will be set as HTTP ONLY.
     */
     ...
     * @throws IllegalArgumentException If there a control characters in the
     * string
     */
     ...
     * the version is 1.1 and the request has a Expect header starting with 102,
     * then a 102 response is sent. This indicates that the request still be
    ...
    /**
     * Get the MetaData.Response committed for this response. This may differ
     * from the meta data in this response for exceptional responses (eg 4xx and
     * 5xx responses generated by the container) and the committedMetaData
     * should be used for logging purposes.
     *
     * @return The committed MetaData or a {@link #newResponseMetaData()} if not
     * yet committed.
     */
