...
/**
 * <p>
 * Customizer that extracts the attribute from an {@link SSLContext} and sets
 * them on the request with {@link ServletRequest#setAttribute(String, Object)}
...
public class SecureRequestCustomizer implements HttpConfiguration.Customizer {
     ...
     * @param stsMaxAgeSeconds The max age in seconds for a
     * Strict-Transport-Security response header. If set less than zero then no
     * header is sent.
     * @param stsIncludeSubdomains If true, a include subdomain property is sent
     * with any Strict-Transport-Security header
     */
    public SecureRequestCustomizer(
    ...
    /**
     * @return The max age in seconds for a Strict-Transport-Security response
     * header. If set less than zero then no header is sent.
     */
    ...
    /**
     * @return true if a include subdomain property is sent with any
    ...
    /**
     * Customizes the request attributes for general secure settings. The
     * default impl calls {@link Request#setSecure(boolean)} with true and sets
     * a response header if the Strict-Transport-Security options are set.
     *
     ...
     * String.</li>
     * <li>an attribute named "javax.servlet.request.key_size" of type
     * Integer.</li>
     * <li>an attribute named "javax.servlet.request.X509Certificate" of type
     * java.security.cert.X509Certificate[]. This is an array of objects of type
     * X509Certificate, the order of this array is defined as being in ascending
     * order of trust. The first certificate in the chain is the one set by the
     * client, the next is the one used to authenticate the first, and so
     * on.</li>
     * </ul>
     *
