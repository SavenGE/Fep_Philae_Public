 ...
 * {@link ConnectionFactory}) so that they are applied to all connections for
 * that connector (or protocol) and thus allow additional Socket configuration
 * to be applied by implementing {@link #customize(Socket, Class, boolean)}
 */
public class SocketCustomizationListener implements Listener {
    ...
    /**
     * @param ssl If True, then a Socket underlying an SSLConnection is
     * unwrapped and notified.
     */
