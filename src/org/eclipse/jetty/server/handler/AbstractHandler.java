 ...
 * AbstractHandler.
 * <p>
 * A convenience implementation of {@link Handler} that uses the
...
public abstract class AbstractHandler extends ContainerLifeCycle implements Handler {
     ...
     * when an {@link DispatcherType#ERROR} dispatch is detected and an error
     * page needs to be generated by calling
     * {@link HttpServletResponse#sendError(int, String)} with the appropriate
     * code and reason, which are taken from
     * {@link HttpServletRequest#getAttribute(String)} for
     * {@link RequestDispatcher#ERROR_STATUS_CODE} and
     * {@link RequestDispatcher#ERROR_MESSAGE}
     *
    ...
    /**
     * An extension of AbstractHandler that handles {@link DispatcherType#ERROR}
     * dispatches.
     * <p>
     * {@link DispatcherType#ERROR} dispatches are handled by calling the
     * {@link #doError(String, Request, HttpServletRequest, HttpServletResponse)}
     * method. All other dispatches are passed to the abstract
     * {@link #doNonErrorHandle(String, Request, HttpServletRequest, HttpServletResponse)}
    ...
    public static abstract class ErrorDispatchHandler extends AbstractHandler {
         ...
         * <code>{@link HttpConnection#getCurrentConnection()}.{@link HttpConnection#getHttpChannel() getHttpChannel()}.{@link HttpChannel#getRequest() getRequest()}</code>
         * method can be used access the Request object if required.
         * @param response The response as the {@link Response} object or a
         * wrapper of that request. The
         * <code>{@link HttpConnection#getCurrentConnection()}.{@link HttpConnection#getHttpChannel() getHttpChannel()}.{@link HttpChannel#getResponse() getResponse()}</code>
         * method can be used access the Response object if required.
         * @throws IOException if unable to handle the request or response
         * processing
         * @throws ServletException if unable to handle the request or response
         * due to underlying servlet issue
         */
