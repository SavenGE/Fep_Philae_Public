...
/* ------------------------------------------------------------ */
/**
 * A handler wrapper that provides the framework to asynchronously delay the
 * handling of a request. While it uses standard servlet API for asynchronous
 * servlets, it adjusts the dispatch type of the request so that it does not
 * appear to be asynchronous during the delayed dispatch.
 *
 */
public class AsyncDelayHandler extends HandlerWrapper {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Called to indicate that a requests handling is being delayed/ The
     * implementation should arrange for context.dispatch() to be called when
     * the request should be handled. It may also set timeouts on the context.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Called to indicated the handling of the request is ending. This is only
     * the end of the current dispatch of the request and if the request is
     * asynchronous, it may be handled again.
     *
