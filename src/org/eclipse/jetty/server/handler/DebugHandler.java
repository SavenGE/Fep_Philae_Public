...
/**
 * Debug Handler. A lightweight debug handler that can be used in production
 * code. Details of the request and response are written to an output stream and
 * the current thread name is updated with information that will link to the
 * details in that output.
 *
