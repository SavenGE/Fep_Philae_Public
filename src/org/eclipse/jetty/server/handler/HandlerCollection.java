 ...
 * <p>
 * The default implementations calls all handlers in list order, regardless of
 * the response status or exceptions. Derived implementation may alter the order
 * or the conditions of calling the contained handlers.
 */
