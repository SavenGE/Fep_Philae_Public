...
/**
 * Handler to adjust the idle timeout of requests while dispatched. Can be
 * applied in jetty.xml with
 * <pre>
...
public class IdleTimeoutHandler extends HandlerWrapper {
     ...
     *
     * @param applyToAsync true if alternate idle timeout is applied to
    ...
    /**
     * @param idleTimeoutMs The idle timeout in MS to apply while dispatched or
     * async
     */
