 ...
 * No caching is done. Requests for resources that do not exist are let pass (Eg
 * no 404's).
 *
 *
 */
public class ResourceHandler extends HandlerWrapper implements ResourceFactory, WelcomeFactory {
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return file extensions that signify that a file is gzip compressed. Eg
     * ".svgz"
     */
     ...
     *
     * @return the minimum size in bytes of a file resource that will be served
     * using a memory mapped buffer, or -1 (default) for no memory mapped
     * buffers.
     */
    @Deprecated
 ...
 /*
    ...
    public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        } else // no resource - try other handlers
        {
            super.handle(target, baseRequest, request, response);
        }
    }
    ...
    /**
     * @return If true, directory listings are returned if no welcome file is
     * found. Else 403 Forbidden.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return If set to true, then static content will be served as gzip
     * content encoded if a matching resource is found ending with ".gz"
     */
    @Deprecated
    ...
    /**
     * @return Precompressed resources formats that can be used to serve
     * compressed variant of resources.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param base The resourceBase to server content from. If null the context
     * resource base is used.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param dirAllowed If true, directory listings are returned if no welcome
     * file is found. Else 403 Forbidden.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param gzip If set to true, then static content will be served as gzip
     * content encoded if a matching resource is found ending with ".gz"
     */
    @Deprecated
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param gzipEquivalentFileExtensions file extensions that signify that a
     * file is gzip compressed. Eg ".svgz"
     */
    ...
    /**
     * @param precompressedFormats The list of precompresed formats to serve in
     * encoded format if matching resource found. For example serve gzip encoded
     * file if ".gz" suffixed resource is found.
     */
     ...
     *
     * @param minAsyncContentLength The minimum size in bytes of the content
     * before asynchronous handling is used, or -1 for no async handling or 0
     * for using {@link HttpServletResponse#getBufferSize()} as the minimum
     * length.
     */
    @Deprecated
     ...
     *
     * @param minMemoryMappedFileSize the minimum size in bytes of a file
     * resource that will be served using a memory mapped buffer, or -1 for no
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param pathInfoOnly true, only the path info will be applied to the
     * resourceBase
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param redirectWelcome If true, welcome files are redirected rather than
     * forwarded to. redirection is always used if the ResourceHandler is not
     * scoped by a ContextHandler
     */
