...
public class StatisticsHandler extends HandlerWrapper implements Graceful {
    ...
    /**
     * @return the number of requests currently active. since
    ...
    /**
     * @return the maximum number of active requests since {@link #statsReset()}
     * was last called.
     */
    ...
    /**
     * @return the standard deviation of time (in milliseconds) of request
     * handling since {@link #statsReset()} was last called.
     * @see #getRequestTimeTotal()
     * @see #getRequests()
     */
    ...
    /**
     * @return the number of responses with a 1xx status returned by this
     * context since {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the number of responses with a 2xx status returned by this
     * context since {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the number of responses with a 3xx status returned by this
     * context since {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the number of responses with a 4xx status returned by this
     * context since {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the number of responses with a 5xx status returned by this
     * context since {@link #statsReset()} was last called.
     */
