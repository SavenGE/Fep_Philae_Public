 ...
 *
 * Postgres uses the getBytes and setBinaryStream methods to access a "bytea"
 * datatype, which can be up to 1Gb of binary data. MySQL is happy to use the
 * "blob" type and getBlob() methods instead.
 *
 */
public class DatabaseAdaptor {
    ...
    /**
     * Convert a camel case identifier into either upper or lower depending on
     * the way the db stores identifiers.
     *
