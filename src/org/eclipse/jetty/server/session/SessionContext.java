 ...
 * SessionContext
 *
 * Information about the context to which sessions belong: the Context, the
 * SessionHandler of the context, and the unique name of the node.
 *
...
public class SessionContext {
    ...
    /**
     * Run a runnable in the context (with context classloader set) if there is
     * one, otherwise just run it.
     *
