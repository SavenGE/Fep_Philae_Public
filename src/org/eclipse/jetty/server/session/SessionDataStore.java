 ...
 * SessionDataStore
 *
 * A store for the data contained in a Session object. The store would usually
 * be persistent.
 */
public interface SessionDataStore extends SessionDataMap {
    ...
    /**
     * Called periodically, this method should search the data store for
     * sessions that have been expired for a 'reasonable' amount of time.
     *
     * @param candidates if provided, these are keys of sessions that the
     * SessionDataStore thinks has expired and should be verified by the
     * SessionDataStore
