 ...
 * AbstractHolder
 *
 * Base class for all servlet-related classes that may be lazily instantiated
 * (eg servlet, filter, listener), and/or require metadata to be held regarding
 * their origin (web.xml, annotation, programmatic api etc).
 *
...
public abstract class BaseHolder<T> extends AbstractLifeCycle implements Dumpable {
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param servletHandler The {@link ServletHandler} that will handle
     * requests dispatched to this servlet.
     */
