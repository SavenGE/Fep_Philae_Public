...
/**
 * An ErrorHandler that maps exceptions and status codes to URIs for dispatch
 * using the internal ERROR style of dispatch.
 */
public class ErrorPageErrorHandler extends ErrorHandler implements ErrorHandler.ErrorPageMapper {
    ...
    /**
     * @param errorPages a map of Exception class names or error codes as a
    ...
    /**
     * Adds ErrorPage mapping for an exception class. This method is called as a
     * result of an exception-type element in a web.xml file or may be called
     * directly
     *
    ...
    /**
     * Adds ErrorPage mapping for a status code. This method is called as a
     * result of an error-code element in a web.xml file or may be called
     * directly.
     *
    ...
    /**
     * Adds ErrorPage mapping for a status code range. This method is not
     * available from web.xml and must be called directly.
     *
