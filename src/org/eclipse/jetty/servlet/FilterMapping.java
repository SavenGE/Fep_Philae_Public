...
public class FilterMapping implements Dumpable {
     ...
     * ({@link #REQUEST}, {@link #ASYNC}, {@link #FORWARD}, {@link #INCLUDE}, or
     * {@link #ERROR})
     */
 ...
 /* ------------------------------------------------------------ */
     ...
     * @param type The type of request: __REQUEST,__FORWARD,__INCLUDE, __ASYNC
     * or __ERROR.
     ...
     * {@link Handler#REQUEST}, {@link Handler#FORWARD}, {@link Handler#INCLUDE}
     * or {@link Handler#ERROR}.
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param pathSpecs The Path specifications to which this filter should be
     * mapped.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param servletNames Maps the {@link #setFilterName(String) named filter}
     * to multiple servlets
     * @see #setServletName
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param servletName Maps the {@link #setFilterName(String) named filter}
     * to a single servlet
     * @see #setServletNames
     */
