 ...
 * Servlet Context.
 * <p>
 * This extension to the ContextHandler allows for simple construction of a
 * context with ServletHandler and optionally session and security handlers, et.
 * <pre>
 *   new ServletContext("/context",Context.SESSIONS|Context.NO_SECURITY);
 * </pre>
 * <p>
 * This class should have been called ServletContext, but this would have cause
 * confusion with {@link ServletContext}.
 */
...
public class ServletContextHandler extends ContextHandler {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add EventListener Adds an EventListener to the list. @see
     * org.eclipse.jetty.server.handler.ContextHandler#addEventListener(). Also
     * adds any listeners that are session related to the SessionHandler.
     *
    ...
    /**
     * notification that a ServletRegistration has been created so we can track
     * the annotations
     *
     ...
     *
     * @param registration ServletRegistration.Dynamic instance that
     * setServletSecurity was called on
     * @param servletSecurityElement new security info
     * @return the set of exact URL mappings currently associated with the
     * registration that are also present in the web.xml security constraints
     * and thus will be unaffected by this call.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param securityHandler The {@link SecurityHandler} to set on this
     * context.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Insert a HandlerWrapper before the first Session,Security or
     * ServletHandler but after any other HandlerWrappers.
     */
    @Override
    ...
    /* ------------------------------------------------------------ */
    /**
     * The DecoratedObjectFactory for use by IoC containers (weld / spring /
     * etc)
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return The decorator list used to resource inject new Filters, Servlets
     * and EventListeners
     * @deprecated use the {@link DecoratedObjectFactory} from
     * getAttribute("org.eclipse.jetty.util.DecoratedObjectFactory") or
     * {@link #getObjectFactory()} instead
     */
    @Deprecated
    ...
    public static class JspPropertyGroup implements JspPropertyGroupDescriptor {
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getUrlPatterns()
         */
        @Override
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getElIgnored()
         */
        @Override
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getIncludePreludes()
         */
        @Override
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getIncludeCodas()
         */
        @Override
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getDeferredSyntaxAllowedAsLiteral()
         */
        @Override
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getTrimDirectiveWhitespaces()
         */
        @Override
        ...
        /**
         * @see
         * javax.servlet.descriptor.JspPropertyGroupDescriptor#getDefaultContentType()
         */
        @Override
