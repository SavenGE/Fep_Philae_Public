 ...
 * used directly when a full web application is not required. If a Web
 * application is required, then this handler should be used as part of a
 * <code>org.eclipse.jetty.webapp.WebAppContext</code>.
 * <p>
 * Unless run as part of a {@link ServletContextHandler} or derivative, the
 * {@link #initialize()} method must be called manually after start().
 */
...
public class ServletHandler extends ScopedHandler {
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return true if ServletHandler always has a default servlet, using
     * {@link Default404Servlet} if no other default servlet is configured.
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param ensureDefaultServlet true if ServletHandler always has a default
     * servlet, using {@link Default404Servlet} if no other default servlet is
     * configured.
     */
     ...
     *
     * @param target Path within _context or servlet name
     * @return MappedResource to the ServletHolder. Named servlets have a null
     * PathSpec
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return true if the handler is started and there are no unavailable
     * servlets
     */
     ...
     *
     * @param filters the filter chain to be cached as a collection of
     * {@link FilterHolder}
     ...
     * @deprecated use {@link #addFilterWithMapping(Class, String, EnumSet)}
     * instead
     */
    @Deprecated
 ...
 /* ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Set the maximum filter chain cache size. Filter chains are cached if
     * {@link #isFilterChainsCached()} is true. If the max cache size is greater
     * than zero, then the cache is flushed whenever it grows to be this size.
     *
     * @param maxFilterChainsCacheSize the maximum number of entries in a filter
     * chain cache.
     */
