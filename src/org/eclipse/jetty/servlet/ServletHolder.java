 ...
 * implements the ServletConfig interface. This class will organise the loading
...
public class ServletHolder extends Holder<Servlet> implements UserIdentity.Scope, Comparable<ServletHolder> {
     ...
     * <p>
     * Holders with order&lt;0, are initialized on use. Those with order&gt;=0
     ...
     *
     * @throws UnavailableException if Servlet class is not of type
    ...
    /* ------------------------------------------------------------ */
    /**
     * Check if there is a javax.servlet.annotation.ServletSecurity annotation
     * on the servlet class. If there is, then we force it to be loaded on
     * startup, because all of the security constraints must be calculated as
    ...
    /* ------------------------------------------------------------ */
    /**
     * Register a ServletRequestListener that will ensure tmp multipart files
     * are deleted when the request goes out of scope.
     *
 ...
 /* -------------------------------------------------------- */
     ...
     * @throws InvocationTargetException If creating new instance throws an
     * exception
     */
