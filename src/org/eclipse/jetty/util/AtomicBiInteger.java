...
public class AtomicBiInteger extends AtomicLong {
    ...
    /**
     * <p>
     * Atomically sets the hi value to the given updated value only if the
     * current value {@code ==} the expected value.</p>
     * <p>
     * Concurrent changes to the lo value result in a retry.</p>
     *
     * @param expectHi the expected hi value
     * @param hi the new hi value
     * @return {@code true} if successful. False return indicates that the
     * actual hi value was not equal to the expected hi value.
     */
    ...
    /**
     * <p>
     * Atomically sets the lo value to the given updated value only if the
     * current value {@code ==} the expected value.</p>
     * <p>
     * Concurrent changes to the hi value result in a retry.</p>
     *
     * @param expectLo the expected lo value
     * @param lo the new lo value
     * @return {@code true} if successful. False return indicates that the
     * actual lo value was not equal to the expected lo value.
     */
    ...
    /**
     * Atomically sets the values to the given updated values only if the
     * current encoded value {@code ==} the expected encoded value.
     *
     * @param encoded the expected encoded value
     * @param hi the new hi value
     * @param lo the new lo value
     * @return {@code true} if successful. False return indicates that the
     * actual encoded value was not equal to the expected encoded value.
     */
     ...
     * @param lo the new lo value
     * @return {@code true} if successful. False return indicates that the
     * actual hi and lo values were not equal to the expected hi and lo value.
     */
    ...
    /**
     * Atomically adds the given delta to the current hi value, returning the
     * updated hi value.
     *
    ...
    /**
     * Atomically adds the given delta to the current lo value, returning the
     * updated lo value.
     *
     * @param delta the delta to apply
