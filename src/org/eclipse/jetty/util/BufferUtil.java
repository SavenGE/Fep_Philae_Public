...
public class BufferUtil {
     ...
     * return value of the previous call to {@link #flipToFill(ByteBuffer)}
     */
     ...
     * @throws BufferOverflowException if unable to append buffer due to space
     * limits
     */
     ...
     *
     * @param to Buffer The buffer to fill to. The buffer will be flipped to
     * fill mode and then flipped back to flush mode.
     ...
     *
     * @param buffer The buffer to convert in flush mode. The buffer is
     * unchanged
     ...
     *
     * @param buffer A buffer containing an integer in flush mode. The position
     * is not changed.
     * @return an int
     */
     ...
     * @return {@code false}
     * @deprecated don't use - there is no way to reliably tell if a ByteBuffer
     * is mapped.
     */
    @Deprecated
