 ...
 * results so that subsequent requests within the same second will be fast.
 *
 * Only format strings that contain either "ss". Sub second formatting is not
 * handled.
 *
...
public class DateCache {
 ...
 /* ------------------------------------------------------------ */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Format a date according to our stored formatter. If it happens to be in
     * the same second as the last formatNow call, then the format is reused.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Format a date according to our stored formatter. The passed time is
     * expected to be close to the current time, so it is compared to the last
     * value passed and if it is within the same second, the format is reused.
     * Otherwise a new cached format is created.
     *
