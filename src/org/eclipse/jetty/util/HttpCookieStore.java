...
/**
 * Implementation of {@link CookieStore} that delegates to an instance created
 * by {@link CookieManager} via {@link CookieManager#getCookieStore()}.
 */
public class HttpCookieStore implements CookieStore {
    ...
    public static List<HttpCookie> matchPath(URI uri, List<HttpCookie> cookies) {
        ...
        for (HttpCookie cookie : cookies) {
            ...
            if (cookiePath == null) {
                result.add(cookie);
            } else // RFC 6265, section 5.1.4, path matching algorithm.
