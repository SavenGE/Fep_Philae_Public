...
public class IPAddressMap<TYPE> extends HashMap<String, TYPE> {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Retrieve the first object that is associated with the specified internet
     * address by taking into account the wildcard specifications.
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Retrieve a lazy list of map entries associated with specified internet
     * address by taking into account the wildcard specifications.
     *
     * @param addr internet address
     ...
     * IPAddrPattern
     *
     * Represents internet address wildcard. Matches the wildcard to provided
     * internet address.
     */
    private static class IPAddrPattern {
         ...
         * @return true if specified internet address matches wildcard
         * specification
         *
         * @throws IllegalArgumentException if specified internet address is
         * invalid
         */
     ...
     * OctetPattern
     *
     * Represents a single octet wildcard. Matches the wildcard to the specified
     * octet value.
     */
