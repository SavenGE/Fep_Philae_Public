...
/**
 * <p>
 * Utility class to handle a Multi Release Jar file</p>
 */
public class MultiReleaseJarFile implements Closeable {
    ...
    /**
     * Construct a multi release jar file for the current JVM version, ignoring
     * directories.
     *
     ...
     * @param includeDirectories true if any directory entries should not be
     * ignored
     * @throws IOException if the jar file cannot be read
     */
    ...
    /**
     * @return The major version applied to this jar for the purposes of
     * selecting entries
     */
    ...
    /**
     * @return A stream of versioned entries from the jar, excluded any that are
     * not applicable
     */
    ...
    public class VersionedJarEntry {
        ...
        /**
         * @return The name of the resource within the jar, which could be
         * versioned
         */
