...
public class ProcessorUtils {
    ...
    /**
     * Obtain the number of available processors, from System Property
     * "JETTY_AVAILABLE_PROCESSORS", or if not set then environment variable
     * "JETTY_AVAILABLE_PROCESSORS" or if not set then
