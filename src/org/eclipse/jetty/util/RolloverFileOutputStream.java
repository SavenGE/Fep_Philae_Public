...
public class RolloverFileOutputStream extends OutputStream {
    ...
    /* ------------------------------------------------------------ */
    /**
     * @param filename The filename must include the string "yyyy_mm_dd", which
     ...
     * is replaced with the actual date when creating and rolling over the file.
     * @param append If true, existing files will be appended to.
     * @param retainDays The number of days to retain files before deleting
     * them. 0 to retain forever.
     * @throws IOException if unable to create output
     */
    public RolloverFileOutputStream(String filename,
            boolean append,
     ...
     * them. 0 to retain forever.
     * @param zone the timezone for the output
     * @param dateFormat The format for the date file substitution. The default
     * is "yyyy_MM_dd". If set to the empty string, the file is rolledover to
     * the same filename, with the current file being renamed to the backup
     * filename.
     * @param backupFormat The format for the file extension of backup files.
     * The default is "HHmmssSSS".
     * @throws IOException if unable to create output
     */
    public RolloverFileOutputStream(String filename,
            boolean append,
     ...
     *
     * @param oldFile The original filename or null if this is the first
     * creation
