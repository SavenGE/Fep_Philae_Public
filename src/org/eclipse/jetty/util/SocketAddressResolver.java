...
/**
 * <p>
 * Creates {@link SocketAddress} instances, returning them through a
 * {@link Promise}.</p>
 */
public interface SocketAddressResolver {
     ...
     * through the given {@link Promise} with the default timeout.
     *
    ...
    /**
     * <p>
     * Creates {@link SocketAddress} instances synchronously in the caller
     * thread.</p>
     */
    ...
    /**
     * <p>
     * Creates {@link SocketAddress} instances asynchronously in a different
     * thread.</p>
     * <p>
     * {@link InetSocketAddress#InetSocketAddress(String, int)} attempts to
     * perform a DNS resolution of the host name, and this may block for several
     * seconds. This class creates the {@link InetSocketAddress} in a separate
     * thread and provides the result through a {@link Promise}, with the
     * possibility to specify a timeout for the operation.</p>
     * <p>
     * Example usage:</p>
     * <pre>
    ...
    public static class Async implements SocketAddressResolver {
        ...
        /**
         * Creates a new instance with the given executor (to perform DNS
         * resolution in a separate thread), the given scheduler (to cancel the
         * operation if it takes too long) and the given timeout, in
         * milliseconds.
         *
         * @param executor the thread pool to use to perform DNS resolution in
         * pooled threads
         * @param scheduler the scheduler to schedule tasks to cancel DNS
         * resolution if it takes too long
         * @param timeout the timeout, in milliseconds, for the DNS resolution
         * to complete
         */
