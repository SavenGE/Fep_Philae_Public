...
public class URIUtil implements Cloneable {
 ...
 /* Decode a URI path and strip parameters of ISO-8859-1 path
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add two encoded URI path segments. Handles null and empty paths, path and
     * query params (eg ?a=b or ;JSESSIONID=xxx) and avoids duplicate '/'
     *
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add two Decoded URI path segments. Handles null and empty paths. Path and
     * query params (eg ?a=b or ;JSESSIONID=xxx) are not handled
     *
     ...
     * </p>
     *
     * @param path the path to convert, decoded, with path separators '/' and no
     * queries.
     ...
     * </p>
     *
     * @param path the path to convert (expects URI/URL form, encoded, and with
     * path separators '/')
     * @return the canonical path, or null if path traversal above root.
     */
