...
public class UrlEncoded extends MultiMap<String> implements Cloneable {
     ...
     * @param equalsForNullValue if True, then an '=' is always used, even for
     * parameters without a value. e.g. <code>"blah?a=&amp;b=&amp;c="</code>.
     * @return the MultiMap as a string encoded with % encodings
     */
     ...
     * @param charset the charset to use for encoding (uses default encoding if
     * null)
     * @param equalsForNullValue if True, then an '=' is always used, even for
     * parameters without a value. e.g. <code>"blah?a=&amp;b=&amp;c="</code>.
     * @return the MultiMap as a string encoded with % encodings.
