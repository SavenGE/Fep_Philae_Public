...
public interface Container {
    ...
    /* ------------------------------------------------------------ */
    /**
     * Add a bean. If the bean is-a {@link Listener}, then also do an implicit
     * {@link #addEventListener(Listener)}.
     *
     ...
     * @return the first bean of a specific class (or subclass), or null if no
     * such bean exist
     * @param <T> the Bean type
     */
    ...
    /**
     * Removes the given bean. If the bean is-a {@link Listener}, then also do
     * an implicit {@link #removeEventListener(Listener)}.
     *
    ...
    /**
     * A listener for Container events. If an added bean implements this
     * interface it will receive the events for this container.
     */
    ...
    /**
     * Inherited Listener. If an added bean implements this interface, then it
     * will be added to all contained beans that are themselves Containers
     */
