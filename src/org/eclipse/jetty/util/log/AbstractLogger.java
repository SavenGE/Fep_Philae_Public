...
public abstract class AbstractLogger implements Logger {
    ...
    /**
     * A more robust form of name blank test. Will return true for null names,
     * and names that have only whitespace
     *
     * @param name the name to test
     * @return true for null or blank name, false if any non-whitespace
     * character is found.
     */
    ...
    /**
     * Condenses a classname by stripping down the package name to just the
     * first character of each package name segment.Configured
     *
     * <pre>
     * Examples:
