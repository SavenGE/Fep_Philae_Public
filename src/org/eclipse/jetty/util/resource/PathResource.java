...
public class PathResource extends Resource {
    ...
    private final static LinkOption NO_FOLLOW_LINKS[] = new LinkOption[]{
    ...
    /**
     * Construct a new PathResource from a parent PathResource and child sub
     * path
     *
     ...
     * @throws IOException if URL doesn't point to a location that can be
     * transformed to a PathResource
     ...
     * The Alias as a Path.
     * <p>
     * Note: this cannot return the alias as a DIFFERENT path in 100% of
     * situations, due to Java's internal Path/File normalization.
     * </p>
     *
