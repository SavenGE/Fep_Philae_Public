...
public abstract class Resource implements ResourceFactory, Closeable {
     ...
     * resource. If it is not found, then the {@link Loader#getResource(String)}
     * method is used. If it is still not found, then
     * {@link ClassLoader#getSystemResource(String)} is used. Unlike
     * {@link ClassLoader#getSystemResource(String)} this method does not check
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return true if the represented resource is a container/directory. if the
     ...
     *
     * @return an File representing the given resource or NULL if this is not
     * possible.
     ...
     *
     * @return an readable bytechannel to the resource or null if one is not
     * available.
     * @throws IOException if unable to open the readable bytechannel for the
     * resource.
     */
     ...
     *
     * @return true if resource was found and successfully deleted, false if
     * resource didn't exist or was unable to be deleted.
     ...
     * @return true if the resource was renamed, false if the resource didn't
     * exist or was unable to be renamed.
    ...
    /* ------------------------------------------------------------ */
    /**
     * list of resource names contained in the given resource. Ordering is
     * unspecified, so callers may wish to sort the return value to ensure
     * deterministic behavior.
     *
     * @return a list of resource names contained in the given resource, or
     * null. Note: The resource names are not URL encoded.
     */
     ...
     * @throws MalformedURLException if the resolution of the path fails because
     * the input path parameter is malformed.
     */
