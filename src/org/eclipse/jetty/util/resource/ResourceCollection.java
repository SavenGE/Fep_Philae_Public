...
/**
 * A collection of resources (dirs). Allows webapps to have multiple (static)
 * sources. The first resource in the collection is the main resource. If a
 * resource is not found in the main resource, it looks it up in the order the
...
public class ResourceCollection extends Resource {
     ...
     * Instantiates a new resource collection.
     *
     * @param csvResources the string containing comma-separated resource
     * strings
     */
    ...
    /* ------------------------------------------------------------ */
    /**
     * Sets the resources as string of comma-separated values. This method
     * should be used when configuring jetty-maven-plugin.
     *
     * @param csvResources the comma-separated string containing one or more
     * resource strings.
     */
     ...
     * @return The contained resource (found first) in the collection of
     * resources
     */
    @Override
     ...
     * @return the resource(file) if found, returns a list of resource dirs if
     * its a dir, else null.
    ...
    /* ------------------------------------------------------------ */
    /**
     * @return The list of resource names(merged) contained in the collection of
     * resources.
     */
    @Override
    public String[] list() {
