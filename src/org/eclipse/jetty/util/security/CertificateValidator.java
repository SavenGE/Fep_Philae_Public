 ...
 *
 * Allows specifying Certificate Revocation List (CRL), as well as enabling CRL
 * Distribution Points Protocol (CRLDP) certificate extension support, and also
 * enabling On-Line Certificate Status Protocol (OCSP) support.
 *
...
public class CertificateValidator {
    ...
    /**
     * Maximum certification path length (n - number of intermediate certs, -1
     * for unlimited)
     */
