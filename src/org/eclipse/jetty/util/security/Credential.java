...
public abstract class Credential implements Serializable {
     ...
     * type is returned. Otherwise, it tries to find a credential provider whose
     * prefix matches with the start of the credential String. Else the
    ...
    /**
     * <p>
     * Utility method that replaces String.equals() to avoid timing attacks. The
     * length of the loop executed will always be the length of the unknown
     * credential</p>
     *
     * @param known the first string to compare (should be known string)
     * @param unknown the second string to compare (should be the unknown
     * string)
    ...
    /**
     * <p>
     * Utility method that replaces Arrays.equals() to avoid timing attacks. The
     * length of the loop executed will always be the length of the unknown
     * credential</p>
     *
