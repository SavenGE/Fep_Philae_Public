 ...
 * on-line algorithm presented in <cite>Donald Knuth's Art of Computer
 * Programming, Volume 2, Semi numerical Algorithms, 3rd edition, page 232,
 * Boston: Addison-Wesley</cite>. That cites a 1962 paper by B.P. Welford:
 * <a href="http://www.jstor.org/pss/1266577">Note on a Method for Calculating
 * Corrected Sums of Squares and Products</a></p>
 * <p>
 * This algorithm is also described in Wikipedia in the section "Online
 * algorithm":
 * <a href="https://en.wikipedia.org/wiki/Algorithms_for_calculating_variance">Algorithms
 * for calculating variance</a>.</p>
 */
public class SampleStatistic {
    ...
    /**
     * @return the average value of the samples recorded, or zero if there are
     * no samples
     */
    ...
    /**
     * @return the variance of the samples recorded, or zero if there are less
     * than 2 samples
     */
