...
/**
 * A {@link org.eclipse.jetty.util.thread.ThreadPool.SizedThreadPool} wrapper
 * around {@link ThreadPoolExecutor}.
 */
...
public class ExecutorThreadPool extends ContainerLifeCycle implements ThreadPool.SizedThreadPool, TryExecutor {
    ...
    /**
     * <p>
     * Sets the maximum thread idle time in ms.</p>
     * <p>
     * Threads that are idle for longer than this period may be stopped.</p>
     *
    ...
    /**
     * @return number of reserved threads or -1 to indicate that the number is
     ...
     *
     * @param reservedThreads number of reserved threads or -1 to determine the
