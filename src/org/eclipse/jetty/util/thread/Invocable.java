...
/**
 * <p>
 * A task (typically either a {@link Runnable} or {@link Callable} that declares
 * how it will behave when invoked:</p>
 * <ul>
 * <li>blocking, the invocation will certainly block (e.g. performs blocking
 * I/O)</li>
 * <li>non-blocking, the invocation will certainly <strong>not</strong>
 * block</li>
...
public interface Invocable {
     ...
     *
     * @return True if the task the current thread is running has indicated that
     * it will not block.
     */
    ...
    /**
     * Invoke a task with the calling thread, tagged to indicate that it will
     * not block.
     *
     ...
     * @return If the object is an Invocable, it is coerced and the
     * {@link #getInvocationType()} used, otherwise
     * {@link InvocationType#BLOCKING} is returned.
     */
