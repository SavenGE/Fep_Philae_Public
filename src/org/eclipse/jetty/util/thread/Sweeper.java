...
/**
 * <p>
 * A utility class to perform periodic sweeping of resources.</p>
 * <p>
 * {@link Sweepable} resources may be added to or removed from a {@link Sweeper}
 * and the resource implementation decides whether it should be swept or
 * not.</p>
 * <p>
 ...
 * on recursively.</p>
 * <p>
 * Typical usage is to add {@link Sweeper} as a bean to an existing
 * container:</p>
 * <pre>
 * Server server = new Server();
 * server.addBean(new Sweeper(), true);
 * server.start();
 * </pre> Code that knows it has sweepable resources can then lookup the
...
public class Sweeper extends AbstractLifeCycle implements Runnable {
     ...
     * {@link Sweeper} or to a parent container if it needs to be swept or
     * not.</p>
     * <p>
     * Typical implementations will check their own internal state and return
     * true or false from {@link #sweep()} to indicate whether they should be
     * swept.</p>
     */
