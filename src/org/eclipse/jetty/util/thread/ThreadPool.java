 ...
 * {@link SizedThreadPool#setMaxThreads(int)}).</p>
 */
...
public interface ThreadPool extends Executor {
    ...
    /**
     * <p>
     * Specialized sub-interface of ThreadPool that allows to get/set the
     * minimum and maximum number of threads of the pool.</p>
     */
