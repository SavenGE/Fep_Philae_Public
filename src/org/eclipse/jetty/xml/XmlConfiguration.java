...
/**
 * <p>
 * Configures objects from XML.</p>
 * <p>
 * This class reads an XML file conforming to the configure.dtd DTD and uses it
 * to configure and object by calling set, put or other methods on the
 * object.</p>
 * <p>
 ...
 * they can share an ID space for beans.</p>
 */
public class XmlConfiguration {
     ...
     *
     * @param configuration String of XML configuration commands excluding the
     * normal XML preamble. The String should start with a "&lt;Configure
     * ....&gt;" element.
     * @throws IOException if the configuration could not be read
     * @throws SAXException if the configuration could not be parsed
     */
     ...
     *
     * @param configuration An input stream containing a complete configuration
     * file
     * @throws IOException if the configuration could not be read
     * @throws SAXException if the configuration could not be parsed
     */
     ...
     * lookup an object from this map.</p>
     * <p>
     ...
     *
     * @param obj The object to be configured, which must be of a type or super
     ...
     *
     * @param args array of property and xml configuration filenames or
     * {@link Resource}s.
